const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/Banner.BnoZWWio.js","assets/index.P3-USlOs.js","assets/index.CXqc9nQ8.css","assets/index.w7I45jiL.js","assets/proxy.CDvHRLVD.js","assets/chevron-right.b0NfCRun.js","assets/createLucideIcon.HhMPbsIC.js","assets/Product.Ch398Ai8.js","assets/ProductCardShimmer.C-IaqHj4.js","assets/WishlistButton.BqPCh-Vo.js","assets/useMutation.OzL2naNM.js","assets/dialog.DhrOuJyQ.js","assets/PaginationSelecctor.CVgQ4KEd.js","assets/usePagination.-xUsidG1.js","assets/NotDataFound.Dip3NAxT.js","assets/PageHeadline.BrGx0y3z.js","assets/useModal.DCEOavDw.js","assets/ButtonBar.XUdr33t3.js","assets/Testimonimal.Ck7uRoZV.js"])))=>i.map(i=>d[i]);
import{r as s,j as e,L as x,_ as o}from"./index.P3-USlOs.js";import p from"./InfiniteProductPage.B4omBtxp.js";import{P as l}from"./ProductCardShimmer.C-IaqHj4.js";import{u as h}from"./useNavbar.TOWLVCwD.js";import"./usePagination.-xUsidG1.js";import"./NotDataFound.Dip3NAxT.js";import"./proxy.CDvHRLVD.js";import"./PageHeadline.BrGx0y3z.js";import"./useModal.DCEOavDw.js";import"./ButtonBar.XUdr33t3.js";import"./WishlistButton.BqPCh-Vo.js";import"./useMutation.OzL2naNM.js";import"./dialog.DhrOuJyQ.js";const f=()=>{const{data:n,isLoading:t}=h(),[i,d]=s.useState(!1),a=n?.results?.find(r=>r.name==="Electronics")?.children||[],c=i?a:a.slice(0,5);return t?e.jsx("section",{className:"px-4 md:px-8 py-10 bg-[#f8fbff]",children:e.jsx("div",{className:"max-w-7xl mx-auto",children:e.jsx("div",{className:"grid grid-cols-3 sm:grid-cols-4 md:grid-cols-5 gap-4",children:Array.from({length:5}).map((r,m)=>e.jsx("div",{className:"h-28 rounded-2xl bg-gray-100 animate-pulse"},m))})})}):e.jsx("section",{className:"px-4 md:px-8 py-10 bg-gradient-to-b from-[#eef6ff] to-[#f8fbff]",children:e.jsxs("div",{className:"max-w-7xl mx-auto",children:[e.jsx("div",{className:"flex items-end justify-between mb-8",children:e.jsxs("div",{children:[e.jsx("p",{className:"text-xs font-semibold text-[#1e73bc] tracking-widest uppercase mb-1",children:"Categories"}),e.jsx("h2",{className:"text-2xl md:text-3xl font-semibold text-gray-900",children:"Shop by Category"}),e.jsx("p",{className:"text-sm text-gray-500 mt-1",children:"Explore products by curated categories"})]})}),e.jsxs("div",{className:"bg-white rounded-3xl border border-[#e6eef7] shadow-[0_20px_60px_rgba(30,115,188,0.08)] p-5 md:p-8",children:[e.jsx("div",{className:`\r
            grid \r
            grid-cols-2 \r
            sm:grid-cols-3 \r
            md:grid-cols-4 \r
