const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/Banner.C1kFjlMy.js","assets/index.DDpga4rK.js","assets/index.CXqc9nQ8.css","assets/index.YNwCp7-L.js","assets/proxy.FBbZVh4u.js","assets/chevron-right.CIhES8mQ.js","assets/createLucideIcon.DPvtBD_E.js","assets/Product.BRhkbNdf.js","assets/ProductCardShimmer.VVYfzE9p.js","assets/WishlistButton.DM2Sxdnz.js","assets/useMutation.-n2Nt91c.js","assets/dialog.BPX6ER_K.js","assets/PaginationSelecctor.DFBnCWw2.js","assets/usePagination.Dm3uUhkI.js","assets/NotDataFound.a8iVYAeW.js","assets/PageHeadline.D8qGiypX.js","assets/useModal.DmKgpb6p.js","assets/ButtonBar.ox0pFpbL.js","assets/Testimonimal.BL-UxaHx.js"])))=>i.map(i=>d[i]);
import{r as s,j as e,L as x,_ as o}from"./index.DDpga4rK.js";import p from"./InfiniteProductPage.1kZLxO8W.js";import{P as l}from"./ProductCardShimmer.VVYfzE9p.js";import{u as h}from"./useNavbar.CVxn60OY.js";import"./usePagination.Dm3uUhkI.js";import"./NotDataFound.a8iVYAeW.js";import"./proxy.FBbZVh4u.js";import"./PageHeadline.D8qGiypX.js";import"./useModal.DmKgpb6p.js";import"./ButtonBar.ox0pFpbL.js";import"./WishlistButton.DM2Sxdnz.js";import"./useMutation.-n2Nt91c.js";import"./dialog.BPX6ER_K.js";const f=()=>{const{data:n,isLoading:t}=h(),[i,d]=s.useState(!1),a=n?.results?.find(r=>r.name==="Electronics")?.children||[],c=i?a:a.slice(0,5);return t?e.jsx("section",{className:"px-4 md:px-8 py-10 bg-[#f8fbff]",children:e.jsx("div",{className:"max-w-7xl mx-auto",children:e.jsx("div",{className:"grid grid-cols-3 sm:grid-cols-4 md:grid-cols-5 gap-4",children:Array.from({length:5}).map((r,m)=>e.jsx("div",{className:"h-28 rounded-2xl bg-gray-100 animate-pulse"},m))})})}):e.jsx("section",{className:"px-4 md:px-8 py-10 bg-gradient-to-b from-[#eef6ff] to-[#f8fbff]",children:e.jsxs("div",{className:"max-w-7xl mx-auto",children:[e.jsx("div",{className:"flex items-end justify-between mb-8",children:e.jsxs("div",{children:[e.jsx("p",{className:"text-xs font-semibold text-[#1e73bc] tracking-widest uppercase mb-1",children:"Categories"}),e.jsx("h2",{className:"text-2xl md:text-3xl font-semibold text-gray-900",children:"Shop by Category"}),e.jsx("p",{className:"text-sm text-gray-500 mt-1",children:"Explore products by curated categories"})]})}),e.jsxs("div",{className:"bg-white rounded-3xl border border-[#e6eef7] shadow-[0_20px_60px_rgba(30,115,188,0.08)] p-5 md:p-8",children:[e.jsx("div",{className:`\r
            grid \r
            grid-cols-2 \r
            sm:grid-cols-3 \r
            md:grid-cols-4 \r
