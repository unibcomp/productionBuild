const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/Banner.CT3gjRAu.js","assets/index.Dtf-RLvG.js","assets/index.CXqc9nQ8.css","assets/index.DQHvWkGh.js","assets/proxy.CeasoCYy.js","assets/chevron-right.CuFK3EaY.js","assets/createLucideIcon.BjASjyrV.js","assets/Product.zji1bYLd.js","assets/ProductCardShimmer.BLv55pWc.js","assets/WishlistButton.SmiLPWZq.js","assets/useMutation.DNEYeBfg.js","assets/dialog.D6oyuNGv.js","assets/PaginationSelecctor.B-NOH4El.js","assets/usePagination.DLbVYjYl.js","assets/NotDataFound.Be-2b-sL.js","assets/PageHeadline.oZXafesm.js","assets/useModal.CQDC9_q7.js","assets/ButtonBar.Dua5Sb8f.js","assets/Testimonimal.BT475Lw8.js"])))=>i.map(i=>d[i]);
import{r as s,j as e,L as x,_ as o}from"./index.Dtf-RLvG.js";import p from"./InfiniteProductPage.Or2ZN2Bt.js";import{P as l}from"./ProductCardShimmer.BLv55pWc.js";import{u as h}from"./useNavbar.C-jiT783.js";import"./usePagination.DLbVYjYl.js";import"./NotDataFound.Be-2b-sL.js";import"./proxy.CeasoCYy.js";import"./PageHeadline.oZXafesm.js";import"./useModal.CQDC9_q7.js";import"./ButtonBar.Dua5Sb8f.js";import"./WishlistButton.SmiLPWZq.js";import"./useMutation.DNEYeBfg.js";import"./dialog.D6oyuNGv.js";const f=()=>{const{data:n,isLoading:t}=h(),[i,d]=s.useState(!1),a=n?.results?.find(r=>r.name==="Electronics")?.children||[],c=i?a:a.slice(0,5);return t?e.jsx("section",{className:"px-4 md:px-8 py-10 bg-[#f8fbff]",children:e.jsx("div",{className:"max-w-7xl mx-auto",children:e.jsx("div",{className:"grid grid-cols-3 sm:grid-cols-4 md:grid-cols-5 gap-4",children:Array.from({length:5}).map((r,m)=>e.jsx("div",{className:"h-28 rounded-2xl bg-gray-100 animate-pulse"},m))})})}):e.jsx("section",{className:"px-4 md:px-8 py-10 bg-gradient-to-b from-[#eef6ff] to-[#f8fbff]",children:e.jsxs("div",{className:"max-w-7xl mx-auto",children:[e.jsx("div",{className:"flex items-end justify-between mb-8",children:e.jsxs("div",{children:[e.jsx("p",{className:"text-xs font-semibold text-[#1e73bc] tracking-widest uppercase mb-1",children:"Categories"}),e.jsx("h2",{className:"text-2xl md:text-3xl font-semibold text-gray-900",children:"Shop by Category"}),e.jsx("p",{className:"text-sm text-gray-500 mt-1",children:"Explore products by curated categories"})]})}),e.jsxs("div",{className:"bg-white rounded-3xl border border-[#e6eef7] shadow-[0_20px_60px_rgba(30,115,188,0.08)] p-5 md:p-8",children:[e.jsx("div",{className:`\r
            grid \r
            grid-cols-2 \r
            sm:grid-cols-3 \r
            md:grid-cols-4 \r
