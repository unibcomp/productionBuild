const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/Banner.jQjiKThB.js","assets/index.CvFP0Aox.js","assets/index.CXqc9nQ8.css","assets/index.raQuysOR.js","assets/proxy.DJyw1u37.js","assets/chevron-right.D984SWOl.js","assets/createLucideIcon.CS7iHRXp.js","assets/Product.D8XsL-k_.js","assets/ProductCardShimmer.BzD-FZLC.js","assets/WishlistButton.CjOi2Vhy.js","assets/useMutation.DN-nuN4j.js","assets/dialog.cYFuPUfx.js","assets/PaginationSelecctor.CGYc2pri.js","assets/usePagination.Ch-es6a-.js","assets/NotDataFound.BuJDJ3lE.js","assets/PageHeadline.DI_CxmGL.js","assets/useModal.xlIAwJhW.js","assets/ButtonBar.DHZmFbBh.js","assets/Testimonimal.CEdLvuXO.js"])))=>i.map(i=>d[i]);
import{r as s,j as e,L as x,_ as o}from"./index.CvFP0Aox.js";import p from"./InfiniteProductPage.CZKZ5U2B.js";import{P as l}from"./ProductCardShimmer.BzD-FZLC.js";import{u as h}from"./useNavbar.COr7Ny7K.js";import"./usePagination.Ch-es6a-.js";import"./NotDataFound.BuJDJ3lE.js";import"./proxy.DJyw1u37.js";import"./PageHeadline.DI_CxmGL.js";import"./useModal.xlIAwJhW.js";import"./ButtonBar.DHZmFbBh.js";import"./WishlistButton.CjOi2Vhy.js";import"./useMutation.DN-nuN4j.js";import"./dialog.cYFuPUfx.js";const f=()=>{const{data:n,isLoading:t}=h(),[i,d]=s.useState(!1),a=n?.results?.find(r=>r.name==="Electronics")?.children||[],c=i?a:a.slice(0,5);return t?e.jsx("section",{className:"px-4 md:px-8 py-10 bg-[#f8fbff]",children:e.jsx("div",{className:"max-w-7xl mx-auto",children:e.jsx("div",{className:"grid grid-cols-3 sm:grid-cols-4 md:grid-cols-5 gap-4",children:Array.from({length:5}).map((r,m)=>e.jsx("div",{className:"h-28 rounded-2xl bg-gray-100 animate-pulse"},m))})})}):e.jsx("section",{className:"px-4 md:px-8 py-10 bg-gradient-to-b from-[#eef6ff] to-[#f8fbff]",children:e.jsxs("div",{className:"max-w-7xl mx-auto",children:[e.jsx("div",{className:"flex items-end justify-between mb-8",children:e.jsxs("div",{children:[e.jsx("p",{className:"text-xs font-semibold text-[#1e73bc] tracking-widest uppercase mb-1",children:"Categories"}),e.jsx("h2",{className:"text-2xl md:text-3xl font-semibold text-gray-900",children:"Shop by Category"}),e.jsx("p",{className:"text-sm text-gray-500 mt-1",children:"Explore products by curated categories"})]})}),e.jsxs("div",{className:"bg-white rounded-3xl border border-[#e6eef7] shadow-[0_20px_60px_rgba(30,115,188,0.08)] p-5 md:p-8",children:[e.jsx("div",{className:`\r
            grid \r
            grid-cols-2 \r
            sm:grid-cols-3 \r
            md:grid-cols-4 \r
