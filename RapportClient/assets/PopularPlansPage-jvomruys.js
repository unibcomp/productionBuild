...
`,p=()=>{let e=t(),[n,r]=(0,l.useState)(null),i=t=>e(`/simstore`,{state:{operatorName:t}}),a=d.find(e=>e.name===n);return(0,u.jsxs)(`div`,{className:`store-container`,style:{backgroundImage:`url(${c})`,backgroundSize:`100% auto`,backgroundPosition:`bottom center`,backgroundRepeat:`no-repeat`},children:[(0,u.jsx)(`style`,{children:f}),(0,u.jsx)(`div`,{className:`grid-header`,children:(0,u.jsx)(`h1`,{className:`grid-title`,children:`Select Your Network`})}),(0,u.jsx)(`div`,{className:`cards-layout-box`,children:d.map(e=>(0,u.jsx)(`div`,{className:`sim-card ${n===e.name?`selected-active`:``}`,style:{"--brand-base-clr":e.color,background:e.bgTop},onClick:()=>r(e.name),children:(0,u.jsxs)(`div`,{className:`card-top-panel`,children:[(0,u.jsx)(`div`,{className:`logo-wrapper`,children:(0,u.jsx)(`img`,{src:e.logoSrc,alt:e.name})}),(0,u.jsx)(`button`,{className:`arrow-btn`,onClick:t=>{t.stopPropagation(),i(e.name)},"aria-label":`View ${e.name} plans`,children:(0,u.jsx)(`span`,{className:`arrow-icon`,children:`→`})}),(0,u.jsx)(`h3`,{style:{color:`white`,fontSize:`24px`,fontWeight:700,margin:`16px 0 0`},children:e.name}),(0,u.jsx)(`div`,{className:`network-pills-row`,children:e.networkTypes.map(e=>(0,u.jsx)(`span`,{className:`net-pill`,children:e},e))})]})},e.name))}),a&&(0,u.jsxs)(`div`,{className:`docked-sticky-footer`,children:[(0,u.jsxs)(`div`,{style:{display:`flex`,alignItems:`center`,gap:`16px`},children:[(0,u.jsx)(`img`,{src:a.logoSrc,width:`40`,alt:``,style:{borderRadius:`10px`}}),(0,u.jsxs)(`span`,{style:{fontWeight:700,fontSize:`16px`},children:[a.name,` Selected`]})]}),(0,u.jsx)(`button`,{style:{background:a.color,color:`white`,padding:`14px 32px`,borderRadius:`99px`,border:`none`,fontWeight:700,cursor:`pointer`,fontSize:`14px`},onClick:()=>i(a.name),children:`View Plans →`})]})]})};export{p as default};