import{t as e}from"./clock-D967An0n.js";import{t}from"./message-square-ClQAcqGk.js";import{t as n}from"./package-DfxRzomF.js";import{t as r}from"./shield-alert-DdQUxKFb.js";import{t as i}from"./wifi-Di1e5fwQ.js";import{$ as a,A as o,F as s,G as c,J as l,K as u,P as ee,Q as te,R as ne,T as d,U as re,V as ie,Y as f,at as p,tt as m}from"./index-c9fj8wbx.js";import{a as ae,f as h,h as g,i as _,l as v,m as y,n as b,p as x,t as S}from"./AddressModal-Cg46HBg_.js";import{t as C}from"./useUser-CVxq_Pyi.js";import{t as w}from"./useEsim-CmzWF70Z.js";var T=p(m(),1);const oe=()=>u({mutationFn:async e=>{let t=localStorage.getItem(`token`),n={};return t&&(n.Authorization=`Bearer ${t}`),(await d.post(`/esim/order`,e,{headers:n})).data.data}});var E=f(),D=`
