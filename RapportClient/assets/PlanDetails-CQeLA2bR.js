import{t as e}from"./check-LlevaZqO.js";import{t}from"./clock-cp7IgZKV.js";import{t as n}from"./message-square-znWrI4ME.js";import{n as r,t as i}from"./plus-ChYt23Ys.js";import{t as a}from"./star-CwXSi7j2.js";import{t as o}from"./wifi-BkgPEGHE.js";import{t as s}from"./zap-C4mKX2Lx.js";import{A as c,B as l,G as u,J as d,M as f,P as p,S as m,U as h,Y as g,Z as _,g as v,q as y,tt as b,w as x,x as ee,z as S}from"./index-biouuIGP.js";import{t as C}from"./proxy-BDQw-q0A.js";import{t as w}from"./AnimatePresence-CbwFusGP.js";import{t as te}from"./usePlanTypes-CtogFJGq.js";import{t as ne}from"./useServices-CRHPRX7L.js";import{t as re}from"./usePlans-C35rTAWx.js";import{t as ie}from"./useUser-BqwBbK3M.js";import{n as ae}from"./useCheckout-D9d0Stys.js";import{t as oe}from"./usePlanTags-n9Elv2-f.js";var se=l(`shield`,[[`path`,{d:`M20 13c0 5-3.5 7.5-7.66 8.95a1 1 0 0 1-.67-.01C7.5 20.5 4 18 4 13V6a1 1 0 0 1 1-1c2 0 4.5-1.2 6.24-2.72a1.17 1.17 0 0 1 1.52 0C14.51 3.81 17 5 19 5a1 1 0 0 1 1 1z`,key:`oel41y`}]]),ce=l(`signal`,[[`path`,{d:`M2 20h.01`,key:`4haj6o`}],[`path`,{d:`M7 20v-4`,key:`j294jx`}],[`path`,{d:`M12 20v-8`,key:`i3yub9`}],[`path`,{d:`M17 20V8`,key:`1tkaf5`}],[`path`,{d:`M22 4v16`,key:`sih9yq`}]]),le=l(`tag`,[[`path`,{d:`M12.586 2.586A2 2 0 0 0 11.172 2H4a2 2 0 0 0-2 2v7.172a2 2 0 0 0 .586 1.414l8.704 8.704a2.426 2.426 0 0 0 3.42 0l6.58-6.58a2.426 2.426 0 0 0 0-3.42z`,key:`vktsd0`}],[`circle`,{cx:`7.5`,cy:`7.5`,r:`.5`,fill:`currentColor`,key:`kqv944`}]]),T=b(_(),1);const E=e=>h({queryKey:e?[`vipCategory`,e]:[`vipCategories`],queryFn:async()=>{try{let t=e?`/vip-category/${e}`:`/vip-category`,{data:n}=await x.get(t);return console.log(`VIP API RESPONSE:`,n),n.data}catch(e){let t=e;throw console.error(`Failed to fetch VIP category:`,e),Error(t.response?.data?.message||t.message||`Something went wrong`)}},enabled:!0,staleTime:300*1e3,retry:2});var D=u(),O=()=>{let{state:l}=y(),{id:u}=g(),h=d(),{data:_,isLoading:b}=re((0,T.useMemo)(()=>u||l?._id,[u,l?._id])),{data:x}=ie(),{data:O}=ne((0,T.useMemo)(()=>typeof _?.serviceId==`string`?_.serviceId:_?.serviceId?._id,[_])),{data:A}=E(_?.vipCategoryId?._id),{data:j=[]}=oe(),{data:M=[]}=te(),{mutate:N,isPending:P}=v(),{mutate:F,isPending:I}=ae(),[L,R]=(0,T.useState)(!1),[z,B]=(0,T.useState)(!1),[V,H]=(0,T.useState)(1),[U,W]=(0,T.useState)(!1),G=(0,T.useMemo)(()=>l?.orderType===`PORT`,[l?.orderType]),ue=(0,T.useMemo)(()=>l?.orderType===`ESIM`,[l?.orderType]),de=G||ue;if((0,T.useEffect)(()=>(document.body.style.overflow=L?`hidden`:``,()=>{document.body.style.overflow=``}),[L]),b)return(0,D.jsxs)(`div`,{className:`pd-center-screen`,children:[(0,D.jsx)(`style`,{children:k}),(0,D.jsxs)(`div`,{className:`pd-loading-card`,children:[(0,D.jsx)(`div`,{className:`pd-spinner`}),(0,D.jsx)(`p`,{className:`pd-loading-text`,children:`Fetching plan details…`})]})]});if(!_)return(0,D.jsxs)(`div`,{className:`pd-center-screen`,children:[(0,D.jsx)(`style`,{children:k}),(0,D.jsxs)(`div`,{className:`pd-notfound-card`,children:[(0,D.jsx)(`div`,{className:`pd-notfound-icon`,children:`🔍`}),(0,D.jsx)(`h2`,{className:`pd-notfound-title`,children:`Plan not found`}),(0,D.jsx)(`p`,{className:`pd-notfound-sub`,children:`This plan may no longer be available.`}),(0,D.jsx)(`button`,{onClick:()=>h(-1),className:`pd-notfound-btn`,children:`← Go Back`})]})]});let K=O?.[0],q=Array.isArray(A)?A[0]:A,fe=typeof _.planTypeId==`object`?_.planTypeId?._id:_.planTypeId,J=j.filter(e=>_.planTagsId?.includes(e._id)),Y=M.find(e=>e._id===fe),pe=()=>{if(!x)return R(!0);let e=l?.orderType||`NORMAL`;F({type:`DIRECT`,planId:_._id,quantity:V},{onSuccess:t=>{h(`/buy-now/${t.sessionId}`,{state:{orderType:e,quantity:V}})}})},me=()=>{if(!x)return R(!0);N({planId:_._id,quantity:V},{onSuccess:()=>{W(!0),setTimeout(()=>W(!1),2e3)}})},X=_.salePrice&&_.price?Math.round((_.price-_.salePrice)/_.price*100):null,Z=typeof _.operatorId==`object`?_.operatorId?.name:`Operator`,Q=typeof _.operatorId==`object`?_.operatorId?.logo:``,he=[{icon:(0,D.jsx)(o,{size:16}),num:_.data??`—`,lbl:`Data / Day`,color:`#3B82F6`},{icon:(0,D.jsx)(t,{size:16}),num:_.validity?`${_.validity}d`:`—`,lbl:`Validity`,color:`#8B5CF6`},{icon:(0,D.jsx)(p,{size:16}),num:_.calls??`—`,lbl:`Calls`,color:`#10B981`},{icon:(0,D.jsx)(n,{size:16}),num:_.sms??`—`,lbl:`SMS / Day`,color:`#F59E0B`},{icon:(0,D.jsx)(ce,{size:16}),num:_.networkType??`—`,lbl:`Network`,color:`#EF4444`}],$=[{key:`Data`,val:_.data},{key:`Validity`,val:_.validity?`${_.validity} Days`:null},{key:`Calls`,val:_.calls},{key:`SMS`,val:_.sms},{key:`Network`,val:_.networkType},{key:`Service`,val:K?.name||(typeof _.serviceId==`string`?_.serviceId:_.serviceId?.name)},{key:`Plan Type`,val:Y?.name||`N/A`}].filter(e=>e.val);return(0,D.jsxs)(`div`,{className:`pd-root`,children:[(0,D.jsx)(`style`,{children:k}),(0,D.jsxs)(`nav`,{className:`pd-nav`,children:[(0,D.jsxs)(`button`,{className:`pd-back-btn`,onClick:()=>h(-1),children:[(0,D.jsx)(S,{size:14}),` Back`]}),(0,D.jsx)(`div`,{className:`pd-nav-center`,children:(0,D.jsx)(`span`,{className:`pd-nav-label`,children:`Plan Details`})}),(0,D.jsx)(`div`,{style:{width:38}})]}),(0,D.jsxs)(C.div,{className:`pd-hero-card`,initial:{opacity:0,y:20},animate:{opacity:1,y:0},transition:{duration:.42},children:[(0,D.jsxs)(`div`,{className:`pd-hero-top`,children:[(0,D.jsxs)(`div`,{className:`pd-op-group`,children:[(0,D.jsx)(`div`,{className:`pd-op-avatar`,children:Q?(0,D.jsx)(`img`,{src:Q,alt:``,style:{width:32,height:32,objectFit:`contain`}}):(0,D.jsx)(`span`,{style:{fontSize:20},children:`📶`})}),(0,D.jsxs)(`div`,{children:[(0,D.jsx)(`div`,{className:`pd-op-name`,children:Z}),(0,D.jsx)(`div`,{className:`pd-op-sub`,children:Y?.name||K?.name||`Prepaid`})]})]}),(0,D.jsxs)(`div`,{className:`pd-hero-badges`,children:[q&&(0,D.jsxs)(`span`,{className:`pd-badge pd-badge-vip`,children:[`👑 `,q.name]}),X&&(0,D.jsxs)(`span`,{className:`pd-badge pd-badge-disc`,children:[X,`% OFF`]})]})]}),(0,D.jsxs)(`div`,{className:`pd-hero-body`,children:[(0,D.jsxs)(`div`,{className:`pd-hero-info`,children:[(0,D.jsxs)(`h1`,{className:`pd-plan-title`,children:[Z,(0,D.jsxs)(`span`,{className:`pd-plan-title-accent`,children:[` `,Y?.name||_.networkType||`Mobile`]}),(0,D.jsx)(`br`,{}),`Plan`]}),_.description&&(0,D.jsx)(`p`,{className:`pd-plan-desc`,children:_.description}),J.length>0&&(0,D.jsx)(`div`,{className:`pd-tags-row`,children:J.map(e=>(0,D.jsxs)(`span`,{className:`pd-tag`,children:[(0,D.jsx)(le,{size:10}),` `,e.name]},e._id))})]}),(0,D.jsxs)(`div`,{className:`pd-price-block`,children:[(0,D.jsx)(`div`,{className:`pd-price-you-pay`,children:`You Pay`}),(0,D.jsxs)(`div`,{className:`pd-price-amount`,children:[`₹`,_.salePrice||_.price]}),_.salePrice&&(0,D.jsxs)(`div`,{className:`pd-price-was`,children:[(0,D.jsxs)(`span`,{className:`pd-price-strike`,children:[`₹`,_.price]}),(0,D.jsxs)(`span`,{className:`pd-price-save`,children:[`Save ₹`,_.price-_.salePrice]})]})]})]})]}),(0,D.jsx)(C.div,{className:`pd-stats-row`,initial:{opacity:0,y:12},animate:{opacity:1,y:0},transition:{delay:.1,duration:.35},children:he.map((e,t)=>(0,D.jsxs)(`div`,{className:`pd-stat-card`,children:[(0,D.jsx)(`div`,{className:`pd-stat-icon`,style:{color:e.color,background:`${e.color}15`},children:e.icon}),(0,D.jsx)(`div`,{className:`pd-stat-num`,children:e.num}),(0,D.jsx)(`div`,{className:`pd-stat-lbl`,children:e.lbl})]},t))}),(0,D.jsxs)(C.div,{className:`pd-details-grid`,initial:{opacity:0,y:14},animate:{opacity:1,y:0},transition:{delay:.18,duration:.36},children:[(0,D.jsxs)(`div`,{className:`pd-detail-card`,children:[(0,D.jsxs)(`div`,{className:`pd-detail-header`,children:[(0,D.jsx)(`div`,{className:`pd-detail-header-icon`,style:{background:`#EFF6FF`,color:`#3B82F6`},children:(0,D.jsx)(se,{size:14})}),(0,D.jsx)(`span`,{children:`Plan Specifications`})]}),(0,D.jsx)(`div`,{className:`pd-spec-list`,children:$.length>0?$.map((e,t)=>(0,D.jsxs)(C.div,{className:`pd-spec-item`,initial:{opacity:0,x:-10},animate:{opacity:1,x:0},transition:{delay:.24+t*.04},children:[(0,D.jsx)(`span`,{className:`pd-spec-key`,children:e.key}),(0,D.jsx)(`span`,{className:`pd-spec-val`,children:e.val})]},t)):(0,D.jsx)(`div`,{className:`pd-empty-state`,children:`No specifications available`})})]}),(0,D.jsxs)(`div`,{className:`pd-detail-card`,children:[(0,D.jsxs)(`div`,{className:`pd-detail-header`,children:[(0,D.jsx)(`div`,{className:`pd-detail-header-icon`,style:{background:`#F0FDF4`,color:`#10B981`},children:(0,D.jsx)(a,{size:14})}),(0,D.jsx)(`span`,{children:`Benefits Included`})]}),(0,D.jsx)(`div`,{className:`pd-benefit-list`,children:_.benefits?.length?_.benefits.map((e,t)=>(0,D.jsxs)(C.div,{className:`pd-benefit-item`,initial:{opacity:0,x:10},animate:{opacity:1,x:0},transition:{delay:.24+t*.05},children:[(0,D.jsx)(`div`,{className:`pd-benefit-dot`}),(0,D.jsx)(`span`,{children:e})]},t)):(0,D.jsx)(`div`,{className:`pd-empty-state`,children:`No benefits listed for this plan`})})]})]}),K?.description&&(0,D.jsxs)(C.div,{className:`pd-service-banner`,initial:{opacity:0},animate:{opacity:1},transition:{delay:.3},children:[(0,D.jsx)(`div`,{className:`pd-service-icon-box`,children:(0,D.jsx)(s,{size:16})}),(0,D.jsxs)(`div`,{children:[(0,D.jsx)(`div`,{className:`pd-service-label`,children:`Service Info`}),(0,D.jsx)(`p`,{className:`pd-service-desc`,children:K.description})]})]}),(0,D.jsx)(`div`,{style:{height:110}}),(0,D.jsxs)(`div`,{className:`pd-bottom-bar`,children:[(0,D.jsxs)(`div`,{className:`pd-bottom-price-group`,children:[(0,D.jsx)(`div`,{className:`pd-bottom-label`,children:`Total`}),(0,D.jsxs)(`div`,{className:`pd-bottom-price-row`,children:[(0,D.jsxs)(`span`,{className:`pd-bottom-price`,children:[`₹`,(_.salePrice||_.price)*V]}),_.salePrice&&(0,D.jsxs)(`span`,{className:`pd-bottom-was`,children:[`₹`,_.price*V]}),X&&(0,D.jsxs)(`span`,{className:`pd-bottom-badge`,children:[X,`% off`]})]})]}),(0,D.jsxs)(`div`,{className:`pd-bottom-actions`,children:[!de&&(0,D.jsxs)(D.Fragment,{children:[(0,D.jsxs)(`div`,{className:`pd-qty-stepper`,children:[(0,D.jsx)(`button`,{className:`pd-qty-btn`,onClick:()=>H(e=>Math.max(1,e-1)),disabled:V<=1,children:(0,D.jsx)(r,{size:13})}),(0,D.jsx)(`span`,{className:`pd-qty-num`,children:V}),(0,D.jsx)(`button`,{className:`pd-qty-btn`,onClick:()=>H(e=>Math.min(10,e+1)),disabled:V>=10,children:(0,D.jsx)(i,{size:13})})]}),(0,D.jsx)(`button`,{className:`pd-cart-btn${U?` pd-cart-btn-added`:``}`,onClick:me,disabled:P,children:U?(0,D.jsxs)(D.Fragment,{children:[(0,D.jsx)(e,{size:15}),` Added!`]}):P?(0,D.jsxs)(D.Fragment,{children:[(0,D.jsx)(f,{size:15}),` Adding…`]}):(0,D.jsxs)(D.Fragment,{children:[(0,D.jsx)(f,{size:15}),` Add to Cart`]})})]}),(0,D.jsx)(`button`,{className:`pd-buy-btn`,onClick:pe,disabled:I,children:I?`Processing...`:G?`Port Now →`:`Buy Now →`})]})]}),(0,D.jsx)(w,{children:L&&(0,D.jsx)(C.div,{className:`pd-overlay`,initial:{opacity:0},animate:{opacity:1},exit:{opacity:0},children:(0,D.jsxs)(C.div,{className:`pd-modal`,initial:{opacity:0,scale:.94,y:24},animate:{opacity:1,scale:1,y:0},exit:{opacity:0,scale:.94,y:24},transition:{duration:.22},children:[(0,D.jsxs)(`div`,{className:`pd-modal-head`,children:[(0,D.jsx)(`button`,{className:`pd-modal-close`,onClick:()=>R(!1),children:(0,D.jsx)(c,{size:14})}),(0,D.jsx)(`h3`,{className:`pd-modal-title`,children:z?`Create Account`:`Welcome Back`}),(0,D.jsx)(`p`,{className:`pd-modal-sub`,children:z?`Sign up to complete your purchase`:`Log in to complete your purchase`})]}),(0,D.jsx)(`div`,{className:`pd-modal-tabs`,children:[`login`,`signup`].map(e=>(0,D.jsx)(`button`,{className:`pd-tab${e===(z?`signup`:`login`)?` pd-tab-active`:``}`,onClick:()=>B(e===`signup`),children:e===`login`?`Login`:`Sign Up`},e))}),(0,D.jsx)(`div`,{className:`pd-modal-body`,children:z?(0,D.jsx)(m,{onSuccess:()=>R(!1)}):(0,D.jsx)(ee,{onSuccess:()=>R(!1),onSignupRedirect:()=>{},onForgotRedirect:()=>{}})})]})})})]})},k=`
