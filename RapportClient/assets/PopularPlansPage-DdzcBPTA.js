import{B as e,K as t,U as n,X as r}from"./index-DqlNmK75.js";import{i,n as a,r as o,t as s}from"./bsnllogo-D1OEI75a.js";var c=r(t(),1),l=e(),u=[{name:`Jio`,desc:`India's Largest 5G Network`,tag:`5G Ready`,networkTypes:[`4G`,`5G`],color:`#0F3CC9`,accentColor:`#3B82F6`,bgTop:`linear-gradient(135deg, #0F3CC9 0%, #062B80 100%)`,bgBottom:`#020F2B`,textPrimary:`#FFFFFF`,textSecondary:`#94A3B8`,logoSrc:a},{name:`Airtel`,desc:`India's Fastest Network`,tag:`Fastest`,networkTypes:[`2G`,`3G`,`4G`,`5G`],color:`#E40000`,accentColor:`#FF4D4D`,bgTop:`linear-gradient(135deg, #E40000 0%, #8B0000 100%)`,bgBottom:`#1E0003`,textPrimary:`#FFFFFF`,textSecondary:`#FDA4AF`,logoSrc:i},{name:`BSNL`,desc:`Connecting India Smoothly`,tag:`Budget`,networkTypes:[`2G`,`3G`,`4G`,`5G Ready`],color:`#997800`,accentColor:`#F58220`,bgTop:`linear-gradient(135deg, #fe7b00 0%, #93b607 100%)`,bgBottom:`#000817`,textPrimary:`#FFFFFF`,textSecondary:`#93C5FD`,logoSrc:s},{name:`Vi`,desc:`Now Stronger Together`,tag:`Value`,networkTypes:[`2G`,`3G`,`4G`,`5G`],color:`#C8102E`,accentColor:`#FFD400`,bgTop:`linear-gradient(135deg, #C8102E 0%, #7A0019 100%)`,bgBottom:`#140002`,textPrimary:`#FFFFFF`,textSecondary:`#FCA5A5`,logoSrc:o}],d=`
  ...
  .store-container { background-color: #FAFAFA; min-height: 20vh; font-family: 'Plus Jakarta Sans', sans-serif; padding-bottom: 60px; }
  .grid-header { text-align: center; padding: 60px 24px 30px; }
  .grid-title { font-family: 'Space Grotesk', sans-serif; font-size: 2.8rem; font-weight: 700; color: #0F172A; }
  
  .cards-layout-box { display: grid; grid-template-columns: repeat(4, 1fr); gap: 28px; max-width: 1300px; margin: 0 auto; padding: 0 24px; }
  
  .sim-card { border-radius: 28px; overflow: hidden; cursor: pointer; border: 2px solid rgba(0,0,0,0.04); transition: transform 0.4s, box-shadow 0.4s; position: relative; }
  ...
  .logo-wrapper { width: 64px; height: 64px; background: #fff; border-radius: 16px; display: flex; align-items: center; justify-content: center; padding: 8px; }
  ...
  @media (max-width: 1024px) {
    .cards-layout-box { grid-template-columns: repeat(2, 1fr); gap: 20px; }
    .grid-title { font-size: 2.2rem; }
  }

  /* Mobile */
  @media (max-width: 640px) {
    .grid-header { padding: 36px 20px 20px; }
...
`,f=()=>{let e=n(),[t,r]=(0,c.useState)(null),i=t=>e(`/simstore`,{state:{operatorName:t}}),a=u.find(e=>e.name===t);return(0,l.jsxs)(`div`,{className:`store-container`,children:[(0,l.jsx)(`style`,{children:d}),(0,l.jsx)(`div`,{className:`grid-header`,children:(0,l.jsx)(`h1`,{className:`grid-title`,children:`Select Your Network`})}),(0,l.jsx)(`div`,{className:`cards-layout-box`,children:u.map(e=>(0,l.jsx)(`div`,{className:`sim-card ${t===e.name?`selected-active`:``}`,style:{"--brand-base-clr":e.color,background:e.bgTop},onClick:()=>r(e.name),children:(0,l.jsxs)(`div`,{className:`card-top-panel`,children:[(0,l.jsx)(`div`,{className:`logo-wrapper`,children:(0,l.jsx)(`img`,{src:e.logoSrc,alt:e.name})}),(0,l.jsx)(`button`,{className:`arrow-btn`,onClick:t=>{t.stopPropagation(),i(e.name)},"aria-label":`View ${e.name} plans`,children:(0,l.jsx)(`span`,{className:`arrow-icon`,children:`→`})}),(0,l.jsx)(`h3`,{style:{color:`white`,fontSize:`24px`,fontWeight:700,margin:`16px 0 0`},children:e.name}),(0,l.jsx)(`div`,{className:`network-pills-row`,children:e.networkTypes.map(e=>(0,l.jsx)(`span`,{className:`net-pill`,children:e},e))})]})},e.name))}),a&&(0,l.jsxs)(`div`,{className:`docked-sticky-footer`,children:[(0,l.jsxs)(`div`,{style:{display:`flex`,alignItems:`center`,gap:`16px`},children:[(0,l.jsx)(`img`,{src:a.logoSrc,width:`40`,alt:``,style:{borderRadius:`10px`}}),(0,l.jsxs)(`span`,{style:{fontWeight:700,fontSize:`16px`},children:[a.name,` Selected`]})]}),(0,l.jsx)(`button`,{style:{background:a.color,color:`white`,padding:`14px 32px`,borderRadius:`99px`,border:`none`,fontWeight:700,cursor:`pointer`,fontSize:`14px`},onClick:()=>i(a.name),children:`View Plans →`})]})]})};export{f as default};