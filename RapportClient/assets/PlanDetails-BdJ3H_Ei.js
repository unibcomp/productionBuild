import{t as e}from"./arrow-left-Bb6gnQEu.js";import{t}from"./check-BPj-ybrV.js";import{t as n}from"./clock-uIQPB2cW.js";import{t as r}from"./message-square-DpFQn2v-.js";import{n as i,t as a}from"./plus-CmgqfAWC.js";import{t as o}from"./wifi-CMNXBXJH.js";import{t as s}from"./zap-VPvRNyT6.js";import{D as c,E as l,G as u,I as d,U as f,V as p,W as m,Z as h,_ as g,b as _,f as v,k as y,q as b,v as x,z as S}from"./index-DQ2UkbOl.js";import{t as C}from"./proxy-BR5n3S39.js";import{t as w}from"./AnimatePresence-BJPqHAuW.js";import{t as ee}from"./usePlanTypes-CJlJL9jX.js";import{t as te}from"./useServices-Daji_u7X.js";import{t as ne}from"./useUser-DRkDLqRc.js";import{t as re}from"./usePlans-CsQLVsy4.js";import{n as ie}from"./useCheckout-C2ndyVMk.js";import{t as ae}from"./usePlanTags-Cu3PQTl9.js";var oe=d(`shield`,[[`path`,{d:`M20 13c0 5-3.5 7.5-7.66 8.95a1 1 0 0 1-.67-.01C7.5 20.5 4 18 4 13V6a1 1 0 0 1 1-1c2 0 4.5-1.2 6.24-2.72a1.17 1.17 0 0 1 1.52 0C14.51 3.81 17 5 19 5a1 1 0 0 1 1 1z`,key:`oel41y`}]]),se=d(`signal`,[[`path`,{d:`M2 20h.01`,key:`4haj6o`}],[`path`,{d:`M7 20v-4`,key:`j294jx`}],[`path`,{d:`M12 20v-8`,key:`i3yub9`}],[`path`,{d:`M17 20V8`,key:`1tkaf5`}],[`path`,{d:`M22 4v16`,key:`sih9yq`}]]),ce=d(`star`,[[`path`,{d:`M11.525 2.295a.53.53 0 0 1 .95 0l2.31 4.679a2.123 2.123 0 0 0 1.595 1.16l5.166.756a.53.53 0 0 1 .294.904l-3.736 3.638a2.123 2.123 0 0 0-.611 1.878l.882 5.14a.53.53 0 0 1-.771.56l-4.618-2.428a2.122 2.122 0 0 0-1.973 0L6.396 21.01a.53.53 0 0 1-.77-.56l.881-5.139a2.122 2.122 0 0 0-.611-1.879L2.16 9.795a.53.53 0 0 1 .294-.906l5.165-.755a2.122 2.122 0 0 0 1.597-1.16z`,key:`r04s7s`}]]),T=d(`tag`,[[`path`,{d:`M12.586 2.586A2 2 0 0 0 11.172 2H4a2 2 0 0 0-2 2v7.172a2 2 0 0 0 .586 1.414l8.704 8.704a2.426 2.426 0 0 0 3.42 0l6.58-6.58a2.426 2.426 0 0 0 0-3.42z`,key:`vktsd0`}],[`circle`,{cx:`7.5`,cy:`7.5`,r:`.5`,fill:`currentColor`,key:`kqv944`}]]),E=h(b(),1);const D=e=>S({queryKey:e?[`vipCategory`,e]:[`vipCategories`],queryFn:async()=>{try{let t=e?`/vip-category/${e}`:`/vip-category`,{data:n}=await _.get(t);return console.log(`VIP API RESPONSE:`,n),n.data}catch(e){let t=e;throw console.error(`Failed to fetch VIP category:`,e),Error(t.response?.data?.message||t.message||`Something went wrong`)}},enabled:!0,staleTime:300*1e3,retry:2});var O=p(),k=()=>{let{state:d}=f();console.log(`Location State:`,d),console.log(`Order Type:`,d?.orderType);let{id:p}=u(),h=m(),{data:_,isLoading:b}=re(p||d?._id),{data:S}=ne(),{data:k}=te(typeof _?.serviceId==`string`?_.serviceId:_?.serviceId?._id),{data:j}=D(_?.vipCategoryId?._id),{data:M=[]}=ae(),{data:N=[]}=ee(),{mutate:P,isPending:F}=v(),{mutate:I,isPending:L}=ie(),[R,z]=(0,E.useState)(!1),[B,le]=(0,E.useState)(!1),[V,H]=(0,E.useState)(1),[U,W]=(0,E.useState)(!1),G=d?.orderType===`PORT`,ue=d?.orderType===`ESIM`,de=G||ue;if(b)return(0,O.jsxs)(`div`,{className:`pd-center-screen`,children:[(0,O.jsx)(`style`,{children:A}),(0,O.jsxs)(`div`,{className:`pd-loading-card`,children:[(0,O.jsx)(`div`,{className:`pd-spinner`}),(0,O.jsx)(`p`,{className:`pd-loading-text`,children:`Fetching plan details…`})]})]});if(!_)return(0,O.jsxs)(`div`,{className:`pd-center-screen`,children:[(0,O.jsx)(`style`,{children:A}),(0,O.jsxs)(`div`,{className:`pd-notfound-card`,children:[(0,O.jsx)(`div`,{className:`pd-notfound-icon`,children:`🔍`}),(0,O.jsx)(`h2`,{className:`pd-notfound-title`,children:`Plan not found`}),(0,O.jsx)(`p`,{className:`pd-notfound-sub`,children:`This plan may no longer be available.`}),(0,O.jsx)(`button`,{onClick:()=>h(-1),className:`pd-notfound-btn`,children:`← Go Back`})]})]});let K=k?.[0],q=Array.isArray(j)?j[0]:j,fe=typeof _.planTypeId==`object`?_.planTypeId?._id:_.planTypeId,J=M.filter(e=>_.planTagsId?.includes(e._id)),Y=N.find(e=>e._id===fe),pe=()=>{if(!S)return z(!0);let e=d?.orderType||`NORMAL`;I({type:`DIRECT`,planId:_._id,quantity:V},{onSuccess:t=>{h(`/buy-now/${t.sessionId}`,{state:{orderType:e,quantity:V}})}})},me=()=>{if(!S)return z(!0);P({planId:_._id,quantity:V},{onSuccess:()=>{W(!0),setTimeout(()=>W(!1),2e3)}})},X=_.salePrice&&_.price?Math.round((_.price-_.salePrice)/_.price*100):null,Z=typeof _.operatorId==`object`?_.operatorId?.name:`Operator`,Q=typeof _.operatorId==`object`?_.operatorId?.logo:``,he=[{icon:(0,O.jsx)(o,{size:16}),num:_.data??`—`,lbl:`Data / Day`,color:`#3B82F6`},{icon:(0,O.jsx)(n,{size:16}),num:_.validity?`${_.validity}d`:`—`,lbl:`Validity`,color:`#8B5CF6`},{icon:(0,O.jsx)(y,{size:16}),num:_.calls??`—`,lbl:`Calls`,color:`#10B981`},{icon:(0,O.jsx)(r,{size:16}),num:_.sms??`—`,lbl:`SMS / Day`,color:`#F59E0B`},{icon:(0,O.jsx)(se,{size:16}),num:_.networkType??`—`,lbl:`Network`,color:`#EF4444`}],$=[{key:`Data`,val:_.data},{key:`Validity`,val:_.validity?`${_.validity} Days`:null},{key:`Calls`,val:_.calls},{key:`SMS`,val:_.sms},{key:`Network`,val:_.networkType},{key:`Service`,val:K?.name||(typeof _.serviceId==`string`?_.serviceId:_.serviceId?.name)},{key:`Plan Type`,val:Y?.name||`N/A`}].filter(e=>e.val);return(0,O.jsxs)(`div`,{className:`pd-root`,children:[(0,O.jsx)(`style`,{children:A}),(0,O.jsxs)(`nav`,{className:`pd-nav`,children:[(0,O.jsxs)(`button`,{className:`pd-back-btn`,onClick:()=>h(-1),children:[(0,O.jsx)(e,{size:14}),` Back`]}),(0,O.jsx)(`div`,{className:`pd-nav-center`,children:(0,O.jsx)(`span`,{className:`pd-nav-label`,children:`Plan Details`})}),(0,O.jsx)(`div`,{style:{width:38}})]}),(0,O.jsxs)(C.div,{className:`pd-hero-card`,initial:{opacity:0,y:20},animate:{opacity:1,y:0},transition:{duration:.42},children:[(0,O.jsxs)(`div`,{className:`pd-hero-top`,children:[(0,O.jsxs)(`div`,{className:`pd-op-group`,children:[(0,O.jsx)(`div`,{className:`pd-op-avatar`,children:Q?(0,O.jsx)(`img`,{src:Q,alt:``,style:{width:32,height:32,objectFit:`contain`}}):(0,O.jsx)(`span`,{style:{fontSize:20},children:`📶`})}),(0,O.jsxs)(`div`,{children:[(0,O.jsx)(`div`,{className:`pd-op-name`,children:Z}),(0,O.jsx)(`div`,{className:`pd-op-sub`,children:Y?.name||K?.name||`Prepaid`})]})]}),(0,O.jsxs)(`div`,{className:`pd-hero-badges`,children:[q&&(0,O.jsxs)(`span`,{className:`pd-badge pd-badge-vip`,children:[`👑 `,q.name]}),X&&(0,O.jsxs)(`span`,{className:`pd-badge pd-badge-disc`,children:[X,`% OFF`]})]})]}),(0,O.jsxs)(`div`,{className:`pd-hero-body`,children:[(0,O.jsxs)(`div`,{className:`pd-hero-info`,children:[(0,O.jsxs)(`h1`,{className:`pd-plan-title`,children:[Z,(0,O.jsxs)(`span`,{className:`pd-plan-title-accent`,children:[` `,Y?.name||_.networkType||`Mobile`]}),(0,O.jsx)(`br`,{}),`Plan`]}),_.description&&(0,O.jsx)(`p`,{className:`pd-plan-desc`,children:_.description}),J.length>0&&(0,O.jsx)(`div`,{className:`pd-tags-row`,children:J.map(e=>(0,O.jsxs)(`span`,{className:`pd-tag`,children:[(0,O.jsx)(T,{size:10}),` `,e.name]},e._id))})]}),(0,O.jsxs)(`div`,{className:`pd-price-block`,children:[(0,O.jsx)(`div`,{className:`pd-price-you-pay`,children:`You Pay`}),(0,O.jsxs)(`div`,{className:`pd-price-amount`,children:[`₹`,_.salePrice||_.price]}),_.salePrice&&(0,O.jsxs)(`div`,{className:`pd-price-was`,children:[(0,O.jsxs)(`span`,{className:`pd-price-strike`,children:[`₹`,_.price]}),(0,O.jsxs)(`span`,{className:`pd-price-save`,children:[`Save ₹`,_.price-_.salePrice]})]})]})]})]}),(0,O.jsx)(C.div,{className:`pd-stats-row`,initial:{opacity:0,y:12},animate:{opacity:1,y:0},transition:{delay:.1,duration:.35},children:he.map((e,t)=>(0,O.jsxs)(`div`,{className:`pd-stat-card`,children:[(0,O.jsx)(`div`,{className:`pd-stat-icon`,style:{color:e.color,background:`${e.color}15`},children:e.icon}),(0,O.jsx)(`div`,{className:`pd-stat-num`,children:e.num}),(0,O.jsx)(`div`,{className:`pd-stat-lbl`,children:e.lbl})]},t))}),(0,O.jsxs)(C.div,{className:`pd-details-grid`,initial:{opacity:0,y:14},animate:{opacity:1,y:0},transition:{delay:.18,duration:.36},children:[(0,O.jsxs)(`div`,{className:`pd-detail-card`,children:[(0,O.jsxs)(`div`,{className:`pd-detail-header`,children:[(0,O.jsx)(`div`,{className:`pd-detail-header-icon`,style:{background:`#EFF6FF`,color:`#3B82F6`},children:(0,O.jsx)(oe,{size:14})}),(0,O.jsx)(`span`,{children:`Plan Specifications`})]}),(0,O.jsx)(`div`,{className:`pd-spec-list`,children:$.length>0?$.map((e,t)=>(0,O.jsxs)(C.div,{className:`pd-spec-item`,initial:{opacity:0,x:-10},animate:{opacity:1,x:0},transition:{delay:.24+t*.04},children:[(0,O.jsx)(`span`,{className:`pd-spec-key`,children:e.key}),(0,O.jsx)(`span`,{className:`pd-spec-val`,children:e.val})]},t)):(0,O.jsx)(`div`,{className:`pd-empty-state`,children:`No specifications available`})})]}),(0,O.jsxs)(`div`,{className:`pd-detail-card`,children:[(0,O.jsxs)(`div`,{className:`pd-detail-header`,children:[(0,O.jsx)(`div`,{className:`pd-detail-header-icon`,style:{background:`#F0FDF4`,color:`#10B981`},children:(0,O.jsx)(ce,{size:14})}),(0,O.jsx)(`span`,{children:`Benefits Included`})]}),(0,O.jsx)(`div`,{className:`pd-benefit-list`,children:_.benefits?.length?_.benefits.map((e,t)=>(0,O.jsxs)(C.div,{className:`pd-benefit-item`,initial:{opacity:0,x:10},animate:{opacity:1,x:0},transition:{delay:.24+t*.05},children:[(0,O.jsx)(`div`,{className:`pd-benefit-dot`}),(0,O.jsx)(`span`,{children:e})]},t)):(0,O.jsx)(`div`,{className:`pd-empty-state`,children:`No benefits listed for this plan`})})]})]}),K?.description&&(0,O.jsxs)(C.div,{className:`pd-service-banner`,initial:{opacity:0},animate:{opacity:1},transition:{delay:.3},children:[(0,O.jsx)(`div`,{className:`pd-service-icon-box`,children:(0,O.jsx)(s,{size:16})}),(0,O.jsxs)(`div`,{children:[(0,O.jsx)(`div`,{className:`pd-service-label`,children:`Service Info`}),(0,O.jsx)(`p`,{className:`pd-service-desc`,children:K.description})]})]}),(0,O.jsx)(`div`,{style:{height:110}}),(0,O.jsxs)(`div`,{className:`pd-bottom-bar`,children:[(0,O.jsxs)(`div`,{className:`pd-bottom-price-group`,children:[(0,O.jsx)(`div`,{className:`pd-bottom-label`,children:`Total`}),(0,O.jsxs)(`div`,{className:`pd-bottom-price-row`,children:[(0,O.jsxs)(`span`,{className:`pd-bottom-price`,children:[`₹`,(_.salePrice||_.price)*V]}),_.salePrice&&(0,O.jsxs)(`span`,{className:`pd-bottom-was`,children:[`₹`,_.price*V]}),X&&(0,O.jsxs)(`span`,{className:`pd-bottom-badge`,children:[X,`% off`]})]})]}),(0,O.jsxs)(`div`,{className:`pd-bottom-actions`,children:[!de&&(0,O.jsxs)(O.Fragment,{children:[(0,O.jsxs)(`div`,{className:`pd-qty-stepper`,children:[(0,O.jsx)(`button`,{className:`pd-qty-btn`,onClick:()=>H(e=>Math.max(1,e-1)),disabled:V<=1,children:(0,O.jsx)(i,{size:13})}),(0,O.jsx)(`span`,{className:`pd-qty-num`,children:V}),(0,O.jsx)(`button`,{className:`pd-qty-btn`,onClick:()=>H(e=>Math.min(10,e+1)),disabled:V>=10,children:(0,O.jsx)(a,{size:13})})]}),(0,O.jsx)(`button`,{className:`pd-cart-btn${U?` pd-cart-btn-added`:``}`,onClick:me,disabled:F,children:U?(0,O.jsxs)(O.Fragment,{children:[(0,O.jsx)(t,{size:15}),` Added!`]}):F?(0,O.jsxs)(O.Fragment,{children:[(0,O.jsx)(c,{size:15}),` Adding…`]}):(0,O.jsxs)(O.Fragment,{children:[(0,O.jsx)(c,{size:15}),` Add to Cart`]})})]}),(0,O.jsx)(`button`,{className:`pd-buy-btn`,onClick:pe,disabled:L,children:L?`Processing...`:G?`Port Now →`:`Buy Now →`})]})]}),(0,O.jsx)(w,{children:R&&(0,O.jsx)(C.div,{className:`pd-overlay`,initial:{opacity:0},animate:{opacity:1},exit:{opacity:0},children:(0,O.jsxs)(C.div,{className:`pd-modal`,initial:{opacity:0,scale:.94,y:24},animate:{opacity:1,scale:1,y:0},exit:{opacity:0,scale:.94,y:24},transition:{duration:.22},children:[(0,O.jsxs)(`div`,{className:`pd-modal-head`,children:[(0,O.jsx)(`button`,{className:`pd-modal-close`,onClick:()=>z(!1),children:(0,O.jsx)(l,{size:14})}),(0,O.jsx)(`h3`,{className:`pd-modal-title`,children:B?`Create Account`:`Welcome Back`}),(0,O.jsx)(`p`,{className:`pd-modal-sub`,children:B?`Sign up to complete your purchase`:`Log in to complete your purchase`})]}),(0,O.jsx)(`div`,{className:`pd-modal-tabs`,children:[`login`,`signup`].map(e=>(0,O.jsx)(`button`,{className:`pd-tab${e===(B?`signup`:`login`)?` pd-tab-active`:``}`,onClick:()=>le(e===`signup`),children:e===`login`?`Login`:`Sign Up`},e))}),(0,O.jsx)(`div`,{className:`pd-modal-body`,children:B?(0,O.jsx)(x,{onSuccess:()=>z(!1)}):(0,O.jsx)(g,{onSuccess:()=>z(!1)})})]})})})]})},A=`
