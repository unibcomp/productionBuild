import{t as e}from"./arrow-left-BmzUGWYv.js";import{t}from"./clock-Dk0bEBf5.js";import{t as n}from"./message-square-BInLBbPn.js";import{t as r}from"./package-Bk_PQSDD.js";import{t as i}from"./phone-CSMzC8Wt.js";import{t as a}from"./shield-check-DrPlUZq5.js";import{t as o}from"./wifi-DERkr7tz.js";import{t as s}from"./zap-mcDzZulZ.js";import{B as c,G as l,J as u,K as d,L as f,O as p,P as m,Q as h,R as g,V as _}from"./index-Bl6eECK3.js";import{t as v}from"./useUser-B-rqvtUN.js";import{t as y}from"./useEsim-Cd4bjBLV.js";var b=h(u(),1);const x=()=>g({mutationFn:async e=>{let t=localStorage.getItem(`token`),n={};return t&&(n.Authorization=`Bearer ${t}`),(await p.post(`/esim/order`,e,{headers:n})).data.data}});var S=_(),C=`
...
`,w=[{code:`IN`,dialCode:`+91`,label:`🇮🇳 India`},{code:`AE`,dialCode:`+971`,label:`🇦🇪 UAE`},{code:`US`,dialCode:`+1`,label:`🇺🇸 USA`},{code:`GB`,dialCode:`+44`,label:`🇬🇧 UK`},{code:`TH`,dialCode:`+66`,label:`🇹🇭 Thailand`},{code:`SG`,dialCode:`+65`,label:`🇸🇬 Singapore`},{code:`JP`,dialCode:`+81`,label:`🇯🇵 Japan`},{code:`AU`,dialCode:`+61`,label:`🇦🇺 Australia`},{code:`DE`,dialCode:`+49`,label:`🇩🇪 Germany`},{code:`FR`,dialCode:`+33`,label:`🇫🇷 France`},{code:`IT`,dialCode:`+39`,label:`🇮🇹 Italy`},{code:`MY`,dialCode:`+60`,label:`🇲🇾 Malaysia`},{code:`ID`,dialCode:`+62`,label:`🇮🇩 Indonesia`}],T=({label:e,name:t,value:n,onChange:r,placeholder:i=``,autoFilled:a=!1,type:o=`text`,fullWidth:s=!1})=>(0,S.jsxs)(`div`,{className:s?`eb-field-full`:``,children:[(0,S.jsx)(`label`,{className:`eb-label`,children:e}),(0,S.jsx)(`input`,{type:o,name:t,value:n,onChange:r,placeholder:i,className:`eb-input${a?` eb-input-autofilled`:``}`})]});function E(){let u=l(),{planId:p}=d(),h=c(),{data:g,isLoading:_}=v(),{data:E,isLoading:D}=y(p),{mutate:O,isPending:k}=x(),[A,j]=(0,b.useState)(!1),[M,N]=(0,b.useState)([]),[P]=(0,b.useState)(`COD`),[F,I]=(0,b.useState)({firstName:``,lastName:``,email:``,address:``,state:``,city:``,pincode:``,countryCode:`IN`,phoneNumber:``});(0,b.useEffect)(()=>{!_&&!g&&queueMicrotask(()=>{j(!0)})},[g,_]),(0,b.useEffect)(()=>{if(!g)return;let e=[],t={},n=(g.fullName||``).trim().split(` `);n[0]&&(t.firstName=n[0],e.push(`firstName`)),n[1]&&(t.lastName=n.slice(1).join(` `),e.push(`lastName`)),g.email&&(t.email=g.email,e.push(`email`));let r=g?.phone||g?.mobile;r&&(t.phoneNumber=r,e.push(`phoneNumber`));let i=g?.countryCode;if(i){let n=w.find(e=>e.code===i||e.dialCode===i);t.countryCode=n?n.code:`IN`,e.push(`countryCode`)}queueMicrotask(()=>{I(e=>({...e,...t})),N(e)})},[g]);let L=e=>{let{name:t,value:n}=e.target;I(e=>({...e,[t]:n})),N(e=>e.filter(e=>e!==t))},R=()=>{if(!g){j(!0);return}if(p){if(!F.firstName.trim())return f.error(`Enter your first name`);if(!F.lastName.trim())return f.error(`Enter your last name`);if(!F.email.trim())return f.error(`Enter your email address`);if(!F.address.trim())return f.error(`Enter your address`);if(!F.city.trim())return f.error(`Enter your city`);if(!F.state.trim())return f.error(`Enter your state`);if(!F.pincode.trim())return f.error(`Enter your pincode`);O({planId:p,...F,paymentMethod:`COD`},{onSuccess:e=>{e?.isKycRequired?(f.success(`KYC required — redirecting…`),window.open(e.ekycLink,`_blank`)):f.success(`eSIM order placed 📱`),h.invalidateQueries({queryKey:[`orders`]}),u(`/profile?tab=orders`)},onError:e=>{f.error(e?.response?.data?.message||`Order failed ❌`)}})}},z=E?.network?.includes(`5G`)?`5G`:E?.network?.includes(`4G`)?`4G LTE`:E?.network;return _||D?(0,S.jsxs)(S.Fragment,{children:[(0,S.jsx)(`style`,{children:C}),(0,S.jsxs)(`div`,{className:`eb-loading`,children:[(0,S.jsx)(`div`,{className:`eb-spinner`}),(0,S.jsxs)(`p`,{style:{fontSize:13,fontWeight:600,color:`#9CA3AF`},children:[`Loading`,D?` plan`:``,`…`]})]})]}):(0,S.jsxs)(S.Fragment,{children:[(0,S.jsx)(`style`,{children:C}),(0,S.jsxs)(`div`,{className:`eb-root`,children:[A&&(0,S.jsx)(`div`,{className:`eb-overlay`,children:(0,S.jsxs)(`div`,{className:`eb-modal`,children:[(0,S.jsx)(`div`,{className:`eb-modal-emoji`,children:`🔐`}),(0,S.jsx)(`div`,{className:`eb-modal-title`,children:`Login Required`}),(0,S.jsx)(`div`,{className:`eb-modal-sub`,children:`You need to be logged in to purchase an eSIM plan. Login to continue and your details will be auto-filled.`}),(0,S.jsx)(`button`,{className:`eb-modal-btn`,onClick:()=>{window.dispatchEvent(new CustomEvent(`open-login-modal`)),j(!1)},children:`Login to Continue`}),(0,S.jsx)(`button`,{className:`eb-modal-dismiss`,onClick:()=>j(!1),children:`Browse as guest`})]})}),(0,S.jsxs)(`nav`,{className:`eb-nav`,children:[(0,S.jsxs)(`button`,{className:`eb-back-btn`,onClick:()=>u(-1),children:[(0,S.jsx)(e,{size:14}),` Back`]}),(0,S.jsxs)(`div`,{className:`eb-nav-center`,children:[(0,S.jsx)(`span`,{className:`eb-nav-icon`,children:`📱`}),(0,S.jsx)(`span`,{className:`eb-nav-title`,children:`Get eSIM`})]}),(0,S.jsx)(`div`,{style:{width:72}})]}),(0,S.jsxs)(`div`,{className:`eb-hero`,children:[(0,S.jsxs)(`div`,{className:`eb-hero-left`,children:[(0,S.jsx)(`div`,{className:`eb-hero-icon`,children:`📱`}),(0,S.jsxs)(`div`,{children:[(0,S.jsx)(`div`,{className:`eb-hero-title`,children:`eSIM Activation`}),(0,S.jsx)(`div`,{className:`eb-hero-sub`,children:`No physical SIM · Instant digital activation · Works on any eSIM device`})]})]}),(0,S.jsx)(`div`,{className:`eb-hero-steps`,children:[`Place Order`,`Get QR Code`,`Scan & Install`,`Active`].map((e,t)=>(0,S.jsxs)(`div`,{className:`eb-hero-step`,children:[(0,S.jsx)(`div`,{className:`eb-hero-step-num`,children:t+1}),(0,S.jsx)(`div`,{className:`eb-hero-step-lbl`,children:e})]},e))})]}),(0,S.jsxs)(`div`,{className:`eb-layout`,children:[(0,S.jsxs)(`div`,{className:`eb-left`,children:[(0,S.jsxs)(`div`,{className:`eb-card`,children:[(0,S.jsx)(`div`,{className:`eb-card-step`,children:`Step 1`}),(0,S.jsx)(`h2`,{className:`eb-card-title`,children:g?`Hey ${g.fullName?.split(` `)[0]||`there`} 👋`:`Personal Information`}),(0,S.jsx)(`p`,{className:`eb-card-sub`,children:`Your name and contact details for the eSIM`}),M.length>0&&(0,S.jsx)(`div`,{className:`eb-autofill-badge`,children:`✓ Details auto-filled from your account`}),(0,S.jsxs)(`div`,{className:`eb-fields`,children:[(0,S.jsx)(T,{label:`First Name`,name:`firstName`,value:F.firstName,onChange:L,placeholder:`John`,autoFilled:M.includes(`firstName`)}),(0,S.jsx)(T,{label:`Last Name`,name:`lastName`,value:F.lastName,onChange:L,placeholder:`Doe`,autoFilled:M.includes(`lastName`)}),(0,S.jsx)(`div`,{className:`eb-field-full`,children:(0,S.jsx)(T,{label:`Email Address`,name:`email`,value:F.email,onChange:L,placeholder:`john@example.com`,type:`email`,fullWidth:!0,autoFilled:M.includes(`email`)})}),(0,S.jsxs)(`div`,{className:`eb-field-full`,children:[(0,S.jsx)(`label`,{className:`eb-label`,children:`Phone Number`}),(0,S.jsxs)(`div`,{className:`eb-phone-wrap`,children:[(0,S.jsx)(`select`,{name:`countryCode`,value:F.countryCode,onChange:e=>{I(t=>({...t,countryCode:e.target.value})),N(e=>e.filter(e=>e!==`countryCode`))},className:`eb-select${M.includes(`countryCode`)?` eb-select-autofilled`:``}`,children:w.map(e=>(0,S.jsxs)(`option`,{value:e.code,children:[e.label,` (`,e.dialCode,`)`]},e.code))}),(0,S.jsx)(`input`,{type:`tel`,name:`phoneNumber`,value:F.phoneNumber,onChange:L,className:`eb-input${M.includes(`phoneNumber`)?` eb-input-autofilled`:``}`,placeholder:`9876543210`})]})]})]})]}),(0,S.jsxs)(`div`,{className:`eb-card`,children:[(0,S.jsx)(`div`,{className:`eb-card-step`,children:`Step 2`}),(0,S.jsx)(`h2`,{className:`eb-card-title`,children:`Billing Address`}),(0,S.jsx)(`p`,{className:`eb-card-sub`,children:`Where should we send the invoice?`}),(0,S.jsxs)(`div`,{className:`eb-fields`,children:[(0,S.jsx)(`div`,{className:`eb-field-full`,children:(0,S.jsx)(T,{label:`Address`,name:`address`,value:F.address,onChange:L,placeholder:`Street, Area, Landmark`,fullWidth:!0})}),(0,S.jsx)(T,{label:`City`,name:`city`,value:F.city,onChange:L,placeholder:`Mumbai`}),(0,S.jsx)(T,{label:`State`,name:`state`,value:F.state,onChange:L,placeholder:`Maharashtra`}),(0,S.jsx)(T,{label:`Pincode`,name:`pincode`,value:F.pincode,onChange:L,placeholder:`400001`})]})]}),(0,S.jsxs)(`div`,{className:`eb-card`,children:[(0,S.jsx)(`div`,{className:`eb-card-step`,children:`Step 3`}),(0,S.jsx)(`h2`,{className:`eb-card-title`,children:`Payment Method`}),(0,S.jsx)(`p`,{className:`eb-card-sub`,children:`How would you like to pay?`}),(0,S.jsx)(`div`,{className:`eb-pay-grid`,children:[`UPI`,`Card`,`Net Banking`,`COD`].map(e=>{let t=e===`COD`;return(0,S.jsxs)(`div`,{className:`eb-pay-item${t&&P===e?` eb-pay-selected`:``}${t?``:` eb-pay-disabled`}`,children:[e,!t&&(0,S.jsx)(`span`,{className:`eb-coming-soon`,children:`Soon`})]},e)})}),(0,S.jsx)(`p`,{className:`eb-pay-note`,children:`Only Cash on Delivery is available right now.`})]})]}),(0,S.jsx)(`div`,{className:`eb-right`,children:(0,S.jsxs)(`div`,{className:`eb-summary-card`,children:[(0,S.jsxs)(`div`,{className:`eb-summary-header`,children:[(0,S.jsx)(r,{size:15}),(0,S.jsx)(`span`,{children:`Order Summary`}),(0,S.jsx)(`span`,{className:`eb-esim-badge`,children:`📱 eSIM`})]}),E&&(0,S.jsxs)(S.Fragment,{children:[(0,S.jsxs)(`div`,{className:`eb-plan-name-block`,children:[(0,S.jsx)(`div`,{className:`eb-plan-name`,children:E.name}),(0,S.jsx)(`div`,{className:`eb-plan-network`,children:E.network})]}),(0,S.jsx)(`div`,{className:`eb-spec-box`,children:[{icon:(0,S.jsx)(o,{size:11}),label:`Data`,val:E.isUnlimited?`Unlimited`:E.dataLimit,green:E.isUnlimited},{icon:(0,S.jsx)(t,{size:11}),label:`Validity`,val:E.validityDays?`${E.validityDays} Days`:null},{icon:(0,S.jsx)(i,{size:11}),label:`Calls`,val:E.callInSeconds==null?null:`${E.callInSeconds}s`},{icon:(0,S.jsx)(n,{size:11}),label:`SMS / Day`,val:E.sms==null?null:`${E.sms}`},{icon:(0,S.jsx)(s,{size:11}),label:`Network`,val:z},{icon:(0,S.jsx)(m,{size:11}),label:`Coverage`,val:E.coverage}].filter(e=>e.val).map((e,t)=>(0,S.jsxs)(`div`,{className:`eb-spec-row`,children:[(0,S.jsxs)(`span`,{className:`eb-spec-key`,children:[e.icon,` `,e.label]}),(0,S.jsx)(`span`,{className:`eb-spec-val${e.green?` eb-spec-val-green`:``}`,children:e.val})]},t))}),(0,S.jsxs)(`div`,{className:`eb-price-section`,children:[(0,S.jsxs)(`div`,{className:`eb-price-row`,children:[(0,S.jsx)(`span`,{children:`Plan Price`}),(0,S.jsxs)(`span`,{children:[`₹`,E.price]})]}),(0,S.jsxs)(`div`,{className:`eb-price-row`,children:[(0,S.jsx)(`span`,{children:`Delivery`}),(0,S.jsx)(`span`,{style:{color:`#16A34A`,fontWeight:700},children:`FREE`})]}),(0,S.jsx)(`div`,{className:`eb-price-divider`}),(0,S.jsxs)(`div`,{className:`eb-price-total-row`,children:[(0,S.jsx)(`span`,{children:`Total`}),(0,S.jsxs)(`span`,{children:[`₹`,E.price]})]})]}),E.fupPolicy&&(0,S.jsxs)(`div`,{className:`eb-fup`,style:{marginTop:14},children:[(0,S.jsx)(`span`,{children:`⚡`}),(0,S.jsx)(`span`,{children:E.fupPolicy})]}),E.countries?.length>0&&(0,S.jsxs)(S.Fragment,{children:[(0,S.jsxs)(`div`,{className:`eb-countries-head`,children:[E.countries.length,` Countr`,E.countries.length===1?`y`:`ies`,` Covered`]}),(0,S.jsxs)(`div`,{className:`eb-countries-wrap`,children:[E.countries.slice(0,10).map(e=>(0,S.jsxs)(`div`,{className:`eb-ctry`,children:[`🏳️ `,e.name]},e._id)),E.countries.length>10&&(0,S.jsxs)(`div`,{className:`eb-ctry`,children:[`+`,E.countries.length-10,` more`]})]})]}),(0,S.jsxs)(`div`,{className:`eb-info-section`,children:[(0,S.jsxs)(`div`,{className:`eb-info-row`,children:[(0,S.jsx)(`span`,{className:`eb-info-key`,children:`Order Type`}),(0,S.jsx)(`span`,{className:`eb-info-val`,children:`eSIM — Digital`})]}),(0,S.jsxs)(`div`,{className:`eb-info-row`,children:[(0,S.jsx)(`span`,{className:`eb-info-key`,children:`Payment`}),(0,S.jsx)(`span`,{className:`eb-info-val`,children:`Cash on Delivery`})]}),(0,S.jsxs)(`div`,{className:`eb-info-row`,children:[(0,S.jsx)(`span`,{className:`eb-info-key`,children:`Delivery`}),(0,S.jsx)(`span`,{className:`eb-info-val`,children:`QR Code via Email`})]})]})]}),(0,S.jsx)(`button`,{className:`eb-pay-btn`,onClick:R,disabled:k,children:k?(0,S.jsxs)(S.Fragment,{children:[(0,S.jsx)(`div`,{className:`eb-pay-spinner`}),` Placing Order…`]}):(0,S.jsxs)(S.Fragment,{children:[`Activate eSIM — ₹`,E?.price??`—`,` →`]})}),(0,S.jsx)(`button`,{className:`eb-cancel-btn`,onClick:()=>u(-1),children:`Cancel`}),(0,S.jsxs)(`div`,{className:`eb-secure-note`,children:[(0,S.jsx)(a,{size:12}),` Secure checkout · Instant eSIM activation`]})]})})]})]})]})}export{E as default};