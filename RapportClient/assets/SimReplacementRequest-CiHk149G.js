import{t as e}from"./clock-D967An0n.js";import{t}from"./map-pin-B27gvFvO.js";import{t as n}from"./package-DfxRzomF.js";import{t as r}from"./wifi-Di1e5fwQ.js";import{B as i,F as a,G as o,J as s,M as c,P as l,Q as u,T as d,U as f,W as p,Y as m,Z as h,at as g,tt as _}from"./index-c9fj8wbx.js";import{a as ee,f as te,h as ne,i as re,l as v,m as y,n as b,p as x,t as S}from"./AddressModal-Cg46HBg_.js";import{t as C}from"./useUser-CVxq_Pyi.js";var w=p(`navigation`,[[`polygon`,{points:`3 11 22 2 13 21 11 13 3 11`,key:`1ltx0t`}]]),T=g(_(),1),E=m(),D=50,O=()=>{let p=u(),m=h().state?.operator,{data:g,isLoading:_}=C(),{data:O=[]}=y(),ie=ne(),A=s(),[j,M]=(0,T.useState)(null),[N,P]=(0,T.useState)(!1),[F,I]=(0,T.useState)(null),[L,R]=(0,T.useState)(!1),[z,B]=(0,T.useState)(!1),[V,H]=(0,T.useState)(``),[U,W]=(0,T.useState)(``),[G,ae]=(0,T.useState)(``),oe=[`SIM Damaged`,`Lost SIM`,`Network Upgrade (4G→5G)`,`Other`],se=e=>e===`Home`?(0,E.jsx)(ee,{size:10}):e===`Work`?(0,E.jsx)(b,{size:10}):(0,E.jsx)(v,{size:10});if((0,T.useEffect)(()=>{O.length>0&&!j&&M((O.find(e=>e.isDefault)||O[0])._id)},[O,j]),!m)return(0,E.jsxs)(`div`,{className:`sr-loading`,children:[(0,E.jsx)(`style`,{children:k}),(0,E.jsx)(`p`,{style:{color:`#4F46E5`,fontWeight:700},children:`No operator selected.`}),(0,E.jsx)(`button`,{className:`sr-back-btn`,onClick:()=>p(`/simreplacement`),children:`Go Back`})]});let K=m.id===`jio`,q=m.id===`bsnl`,J=m.buttonGradient,Y=m.tileGradient,X=O.find(e=>e._id===j),Z=V.length===10,Q=V.length>0&&V.length<10,$=`${m.id.slice(0,3).toUpperCase()}-${V?V.slice(-4):`····`}`,ce=()=>{if(!navigator.geolocation){o.error(`Location not supported on this device`);return}navigator.geolocation.getCurrentPosition(async e=>{let{latitude:t,longitude:n}=e.coords;try{let e=(await(await fetch(`https://nominatim.openstreetmap.org/reverse?lat=${t}&lon=${n}&format=json`)).json()).address||{},r=`Current Location`,i=e.road||e.suburb||e.neighbourhood||``,a=e.city||e.town||e.village||`Gurugram`,s=e.state||`Haryana`,c=e.postcode||`000000`,l=O.find(e=>e.houseNo===`Current Location`),u;u=l?await d.put(`/address/${l._id}`,{houseNo:r,street:i,city:a,state:s,pincode:c,latitude:t,longitude:n}):await d.post(`/address`,{houseNo:r,street:i,city:a,state:s,pincode:c,latitude:t,longitude:n});let f=u.data.data;A.invalidateQueries({queryKey:[`address`]}),M(f._id),o.success(`Location fetched 📍`)}catch{o.error(`Failed to fetch address`)}},()=>o.error(`Location permission denied`))},le=async()=>{if(!X)return o.error(`Select a delivery address`);if(!Z)return o.error(`Enter a valid 10-digit existing number`);if(!G)return o.error(`Select a reason for replacement`);B(!0);try{await d.post(`/sim-replacement`,{addressId:X._id,operatorId:m.id,existingNumber:V,lastRechargeAmount:U,reason:G,paymentMethod:`COD`}),R(!0)}catch(e){o.error(e?.response?.data?.message||`Request failed ❌`)}finally{B(!1)}};return _?(0,E.jsxs)(`div`,{className:`sr-loading`,children:[(0,E.jsx)(`style`,{children:k}),(0,E.jsx)(`div`,{className:`sr-spinner`})]}):(0,E.jsxs)(`div`,{className:`sr-root`,style:{"--op-color":m.color},children:[(0,E.jsx)(`style`,{children:k}),(0,E.jsxs)(`nav`,{className:`sr-nav`,children:[(0,E.jsxs)(`button`,{className:`sr-back-btn`,onClick:()=>p(`/simreplacement`),children:[(0,E.jsx)(f,{size:14}),` Back`]}),(0,E.jsxs)(`div`,{className:`sr-nav-center`,children:[(0,E.jsx)(`span`,{className:`sr-nav-dot`}),(0,E.jsxs)(`span`,{className:`sr-nav-title`,children:[m.name,` · SIM Replacement`]})]}),(0,E.jsx)(`div`,{className:`sr-nav-ref`,children:!K&&!L?$:``})]}),(0,E.jsxs)(`div`,{className:`sr-hero`,children:[(0,E.jsx)(`div`,{className:`sr-hero-bg`}),(0,E.jsxs)(`div`,{className:`sr-hero-inner`,children:[(0,E.jsxs)(`div`,{className:`sr-hero-left`,children:[(0,E.jsx)(`div`,{className:`sr-hero-icon`,children:K?(0,E.jsx)(t,{size:20}):(0,E.jsx)(r,{size:20})}),(0,E.jsxs)(`div`,{children:[(0,E.jsx)(`div`,{className:`sr-hero-eyebrow`,children:K?`In-store request`:`Doorstep request`}),(0,E.jsx)(`div`,{className:`sr-hero-title`,children:K?`Visit your nearest Jio store`:`Get a replacement SIM, same number`}),(0,E.jsx)(`div`,{className:`sr-hero-sub`,children:K?`Aadhaar e-KYC verification · in person only · same-day activation`:`Verify your last recharge · doorstep delivery · 24–48 hr dispatch`})]})]}),!K&&(0,E.jsx)(`ol`,{className:`sr-hero-steps`,children:[`Verify details`,`Confirm address`,`Pay fee`,`SIM dispatched`].map((e,t)=>(0,E.jsxs)(`li`,{className:`sr-hero-step`,children:[(0,E.jsx)(`span`,{className:`sr-hero-step-num`,children:t+1}),(0,E.jsx)(`span`,{className:`sr-hero-step-lbl`,children:e})]},e))})]})]}),K?(0,E.jsx)(`div`,{className:`sr-layout`,style:{gridTemplateColumns:`1fr`},children:(0,E.jsxs)(`div`,{className:`sr-left`,children:[(0,E.jsxs)(`div`,{className:`sr-card`,children:[(0,E.jsx)(`div`,{className:`sr-card-eyebrow`,children:`What to carry`}),(0,E.jsx)(`h2`,{className:`sr-card-title`,children:`Required for biometric e-KYC`}),(0,E.jsx)(`div`,{className:`sr-jio-grid`,children:[{icon:c,label:`Aadhaar card`,sub:`Original, for biometric e-KYC`},{icon:a,label:`Existing Jio number`,sub:`The one you're replacing`}].map(e=>(0,E.jsxs)(`div`,{className:`sr-jio-item`,children:[(0,E.jsx)(`div`,{className:`sr-jio-icon`,children:(0,E.jsx)(e.icon,{size:17})}),(0,E.jsx)(`p`,{className:`sr-jio-label`,children:e.label}),(0,E.jsx)(`p`,{className:`sr-jio-sub`,children:e.sub})]},e.label))})]}),(0,E.jsxs)(`div`,{className:`sr-card`,children:[(0,E.jsx)(`div`,{className:`sr-card-eyebrow`,children:`Store info`}),(0,E.jsx)(`h2`,{className:`sr-card-title`,children:`Find your nearest store`}),(0,E.jsxs)(`div`,{className:`sr-store-row`,children:[(0,E.jsxs)(`div`,{className:`sr-store-info`,children:[(0,E.jsx)(e,{size:17}),(0,E.jsxs)(`div`,{children:[(0,E.jsx)(`p`,{className:`sr-store-label`,children:`Store hours`}),(0,E.jsx)(`p`,{className:`sr-store-val`,children:`10:00 AM – 8:00 PM, all days`})]})]}),(0,E.jsxs)(`div`,{className:`sr-store-info`,children:[(0,E.jsx)(w,{size:17}),(0,E.jsxs)(`div`,{children:[(0,E.jsx)(`p`,{className:`sr-store-label`,children:`Avg. wait time`}),(0,E.jsx)(`p`,{className:`sr-store-val`,children:`~15–20 minutes`})]})]})]}),(0,E.jsxs)(`a`,{href:`https://www.jio.com/store-locator`,target:`_blank`,rel:`noopener noreferrer`,className:`sr-store-cta`,children:[(0,E.jsx)(t,{size:18}),` Open store locator`]})]})]})}):L?(0,E.jsx)(`div`,{className:`sr-success-wrap`,children:(0,E.jsxs)(`div`,{className:`sr-success-card`,children:[(0,E.jsx)(`div`,{className:`sr-success-icon`,children:(0,E.jsx)(i,{size:28})}),(0,E.jsx)(`h3`,{className:`sr-success-title`,children:`Request submitted`}),(0,E.jsxs)(`p`,{className:`sr-success-sub`,children:[`Your `,m.name,` SIM replacement request has been received.`]}),(0,E.jsx)(`p`,{className:`sr-success-sub`,children:`A new SIM will be dispatched to your address within 24–48 hours.`}),(0,E.jsxs)(`div`,{className:`sr-success-ref`,children:[`Reference `,$]}),(0,E.jsx)(`button`,{className:`sr-pay-btn`,style:{maxWidth:220,margin:`22px auto 0`,...q&&J?{background:J}:{}},onClick:()=>p(`/simreplacement`),children:`Done`})]})}):(0,E.jsxs)(`div`,{className:`sr-layout`,children:[(0,E.jsxs)(`div`,{className:`sr-left`,children:[(0,E.jsxs)(`div`,{className:`sr-card`,children:[(0,E.jsx)(`div`,{className:`sr-card-eyebrow`,children:`Step 1 of 2`}),(0,E.jsx)(`h2`,{className:`sr-card-title`,children:g?`Hey ${g.fullName||g.name} 👋`:`Delivery address`}),(0,E.jsx)(`p`,{className:`sr-card-sub`,children:`Where should we deliver your new SIM?`}),(0,E.jsx)(`div`,{className:`sr-addr-grid`,children:O.map(e=>(0,E.jsxs)(`div`,{className:`sr-addr-item${j===e._id?` sr-addr-selected`:``}`,onClick:()=>M(e._id),children:[(0,E.jsxs)(`div`,{className:`sr-addr-top`,children:[(0,E.jsxs)(`div`,{children:[e.addressLabel&&(0,E.jsxs)(`span`,{className:`sr-addr-label-tag`,children:[se(e.addressLabel),` `,e.addressLabel]}),(0,E.jsxs)(`p`,{className:`sr-addr-line`,children:[e.houseNo,`, `,e.street]})]}),e.isDefault&&(0,E.jsx)(`span`,{className:`sr-default-badge`,children:`Default`})]}),(0,E.jsxs)(`p`,{className:`sr-addr-city`,children:[e.city,`, `,e.state,` — `,e.pincode]}),(0,E.jsxs)(`div`,{className:`sr-addr-actions`,children:[(0,E.jsxs)(`button`,{className:`sr-addr-edit`,onClick:t=>{t.stopPropagation(),I(e),P(!0)},children:[(0,E.jsx)(re,{size:11}),` Edit`]}),(0,E.jsxs)(`button`,{className:`sr-addr-del`,onClick:t=>{t.stopPropagation(),ie.mutate(e._id,{onSuccess:()=>A.invalidateQueries({queryKey:[`address`]})})},children:[(0,E.jsx)(x,{size:11}),` Remove`]})]})]},e._id))}),(0,E.jsxs)(`div`,{className:`sr-addr-btns`,children:[(0,E.jsxs)(`button`,{className:`sr-add-addr-btn`,onClick:()=>{I(null),P(!0)},children:[(0,E.jsx)(te,{size:14}),` Add address`]}),(0,E.jsxs)(`button`,{className:`sr-loc-btn`,onClick:ce,children:[(0,E.jsx)(v,{size:14}),` Use my location`]})]})]}),(0,E.jsxs)(`div`,{className:`sr-card sr-replace-card`,children:[(0,E.jsxs)(`div`,{className:`sr-replace-header`,children:[(0,E.jsx)(`div`,{className:`sr-replace-header-icon`,style:q&&Y?{background:Y,color:`#fff`}:{},children:(0,E.jsx)(l,{size:19})}),(0,E.jsxs)(`div`,{children:[(0,E.jsx)(`div`,{className:`sr-card-eyebrow`,style:{marginBottom:2},children:`Step 2 of 2 — Verification`}),(0,E.jsx)(`h2`,{className:`sr-card-title`,style:{marginBottom:0},children:`Your current number & last recharge`})]})]}),(0,E.jsx)(`p`,{className:`sr-card-sub`,style:{marginTop:14},children:`This helps us confirm ownership before issuing your new SIM`}),(0,E.jsxs)(`div`,{className:`sr-replace-fields`,children:[(0,E.jsxs)(`div`,{className:`sr-field-group`,children:[(0,E.jsxs)(`label`,{className:`sr-field-label`,children:[`Existing `,m.name,` number`]}),(0,E.jsxs)(`div`,{className:`sr-number-wrap`,children:[(0,E.jsx)(`div`,{className:`sr-number-prefix`,children:`+91`}),(0,E.jsx)(`input`,{className:`sr-number-input${Z?` sr-input-ok`:Q?` sr-input-warn`:``}`,type:`tel`,inputMode:`numeric`,placeholder:`Enter 10-digit number`,value:V,onChange:e=>H(e.target.value.replace(/\D/g,``).slice(0,10)),maxLength:10}),Z&&(0,E.jsx)(`div`,{className:`sr-input-check`,children:`✓`})]}),(0,E.jsx)(`div`,{className:`sr-progress-track`,children:(0,E.jsx)(`div`,{className:`sr-progress-fill${Z?` sr-progress-ok`:``}`,style:{width:`${V.length/10*100}%`,...Z&&q&&J?{background:J}:{}}})}),(0,E.jsxs)(`div`,{className:`sr-number-meta`,children:[Z?(0,E.jsx)(`span`,{className:`sr-meta-ok`,children:`✓ Valid number — ready to verify`}):Q?(0,E.jsxs)(`span`,{className:`sr-meta-warn`,children:[10-V.length,` more digit`,10-V.length==1?``:`s`,` needed`]}):(0,E.jsx)(`span`,{className:`sr-meta-neutral`,children:`This number will receive the activation OTP`}),(0,E.jsxs)(`span`,{className:`sr-meta-count`,children:[V.length,`/10`]})]})]}),(0,E.jsx)(`div`,{className:`sr-divider`,children:(0,E.jsx)(`span`,{className:`sr-divider-label`,children:`Last recharge details`})}),(0,E.jsxs)(`div`,{className:`sr-field-group`,children:[(0,E.jsxs)(`label`,{className:`sr-field-label`,children:[`Last recharge amount (₹) `,(0,E.jsx)(`span`,{className:`sr-optional-tag`,children:`Optional`})]}),(0,E.jsx)(`input`,{className:`sr-text-input`,type:`number`,placeholder:`e.g. 299`,value:U,onChange:e=>W(e.target.value)})]}),(0,E.jsx)(`div`,{className:`sr-divider`,children:(0,E.jsx)(`span`,{className:`sr-divider-label`,children:`Reason for replacement`})}),(0,E.jsx)(`div`,{className:`sr-field-group`,children:(0,E.jsx)(`div`,{className:`sr-reason-grid`,children:oe.map(e=>{let t=G===e;return(0,E.jsx)(`button`,{type:`button`,onClick:()=>ae(e),className:`sr-reason-card${t?` sr-reason-active`:``}`,style:t&&q&&J?{background:J,borderColor:`transparent`,color:`#fff`}:{},children:e},e)})})}),(0,E.jsxs)(`div`,{className:`sr-timeline`,children:[(0,E.jsx)(`div`,{className:`sr-timeline-header`,children:`What happens next`}),(0,E.jsx)(`div`,{className:`sr-timeline-items`,children:[{title:`Identity verified`,desc:`We match your number and last recharge to confirm ownership`},{title:`SIM dispatched`,desc:`New SIM card delivered to your address within 24–48 hours`},{title:`Activated`,desc:`Insert the new SIM — your number stays exactly the same`}].map((e,t)=>(0,E.jsxs)(`div`,{className:`sr-timeline-item`,children:[(0,E.jsx)(`div`,{className:`sr-timeline-icon`,style:q&&J?{background:J,borderColor:`transparent`,color:`#fff`}:{},children:t+1}),(0,E.jsx)(`div`,{className:`sr-timeline-line`}),(0,E.jsxs)(`div`,{className:`sr-timeline-content`,children:[(0,E.jsx)(`div`,{className:`sr-timeline-title`,children:e.title}),(0,E.jsx)(`div`,{className:`sr-timeline-desc`,children:e.desc})]})]},t))})]})]})]})]}),(0,E.jsx)(`div`,{className:`sr-right`,children:(0,E.jsxs)(`div`,{className:`sr-ticket`,children:[(0,E.jsxs)(`div`,{className:`sr-ticket-top`,children:[(0,E.jsxs)(`div`,{className:`sr-summary-header`,children:[(0,E.jsx)(n,{size:14}),(0,E.jsx)(`span`,{children:`Replacement docket`})]}),(0,E.jsxs)(`div`,{className:`sr-op-row`,children:[(0,E.jsx)(`div`,{className:`sr-op-avatar`,style:q&&Y?{background:Y,color:`#fff`}:{},children:m.name[0]}),(0,E.jsxs)(`div`,{children:[(0,E.jsxs)(`span`,{className:`sr-op-name`,children:[m.name,` SIM replacement`]}),(0,E.jsx)(`div`,{className:`sr-op-sub`,children:`New SIM, same number`})]}),(0,E.jsx)(`div`,{className:`sr-ticket-id`,children:$})]}),(0,E.jsx)(`div`,{className:`sr-spec-box`,children:[{label:`Existing number`,val:V?`+91 ${V}`:`—`},{label:`Last recharge`,val:U?`₹${U}`:`Not provided`},{label:`Reason`,val:G||`—`}].map((e,t)=>(0,E.jsxs)(`div`,{className:`sr-spec-row`,children:[(0,E.jsx)(`span`,{className:`sr-spec-key`,children:e.label}),(0,E.jsx)(`span`,{className:`sr-spec-val`,children:e.val})]},t))})]}),(0,E.jsxs)(`div`,{className:`sr-perf`,children:[(0,E.jsx)(`span`,{className:`sr-perf-notch sr-perf-notch-l`}),(0,E.jsx)(`span`,{className:`sr-perf-line`}),(0,E.jsx)(`span`,{className:`sr-perf-notch sr-perf-notch-r`})]}),(0,E.jsxs)(`div`,{className:`sr-ticket-bottom`,children:[(0,E.jsxs)(`div`,{className:`sr-price-section`,children:[(0,E.jsxs)(`div`,{className:`sr-price-row`,children:[(0,E.jsx)(`span`,{children:`Replacement fee`}),(0,E.jsxs)(`span`,{children:[`₹`,D]})]}),(0,E.jsxs)(`div`,{className:`sr-price-row`,children:[(0,E.jsx)(`span`,{children:`Delivery`}),(0,E.jsx)(`span`,{className:`sr-free-tag`,children:`Free`})]}),(0,E.jsx)(`div`,{className:`sr-price-divider`}),(0,E.jsxs)(`div`,{className:`sr-price-total-row`,children:[(0,E.jsx)(`span`,{children:`Total`}),(0,E.jsxs)(`span`,{style:q&&Y?{backgroundImage:Y,WebkitBackgroundClip:`text`,backgroundClip:`text`,color:`transparent`}:{},children:[`₹`,D]})]})]}),(0,E.jsxs)(`div`,{className:`sr-info-section`,children:[(0,E.jsxs)(`div`,{className:`sr-info-row`,children:[(0,E.jsx)(`span`,{className:`sr-info-key`,children:`Deliver to`}),(0,E.jsx)(`span`,{className:`sr-info-val`,children:X?`${X.houseNo}, ${X.street}`:`—`})]}),(0,E.jsxs)(`div`,{className:`sr-info-row`,children:[(0,E.jsx)(`span`,{className:`sr-info-key`,children:`Payment`}),(0,E.jsx)(`span`,{className:`sr-info-val`,children:`Cash on delivery`})]})]}),(0,E.jsxs)(`div`,{className:`sr-readiness`,children:[(0,E.jsxs)(`div`,{className:`sr-ready-row`,children:[(0,E.jsx)(`span`,{className:`sr-ready-dot${j?` ok`:``}`}),(0,E.jsx)(`span`,{className:`sr-ready-txt${j?` ok`:``}`,children:`Delivery address`})]}),(0,E.jsxs)(`div`,{className:`sr-ready-row`,children:[(0,E.jsx)(`span`,{className:`sr-ready-dot${Z?` ok`:``}`}),(0,E.jsxs)(`span`,{className:`sr-ready-txt${Z?` ok`:``}`,children:[`Mobile number (`,V.length,`/10)`]})]}),(0,E.jsxs)(`div`,{className:`sr-ready-row`,children:[(0,E.jsx)(`span`,{className:`sr-ready-dot${G?` ok`:``}`}),(0,E.jsxs)(`span`,{className:`sr-ready-txt${G?` ok`:``}`,children:[`Reason `,G?`(${G})`:``]})]})]}),(0,E.jsx)(`button`,{className:`sr-pay-btn`,style:q&&J?{background:J}:{},onClick:le,disabled:z,children:z?`Submitting…`:(0,E.jsxs)(E.Fragment,{children:[(0,E.jsx)(l,{size:16,style:{marginRight:6,verticalAlign:-2}}),`Confirm replacement — ₹`,D]})}),(0,E.jsx)(`button`,{className:`sr-cancel-btn`,onClick:()=>p(-1),children:`Cancel`})]})]})})]}),N&&(0,E.jsx)(S,{close:()=>{P(!1),I(null)},editingAddress:F})]})},k=`
