import{t as e}from"./circle-check-BU-0x3VM.js";import{t}from"./clock-CWQz2BVn.js";import{t as n}from"./map-pin-OqYkDMxS.js";import{t as r}from"./package-drgozA-r.js";import{t as i}from"./wifi-DvUJTBff.js";import{B as a,G as o,J as s,N as c,P as l,V as u,W as d,Z as f,j as p,q as m,tt as h,w as g,z as _}from"./index-D-zxq-Ip.js";import{d as v,f as y,l as b,n as x,o as ee,p as S,u as C}from"./fi-BIS7eXS2.js";import{t as w}from"./useUser-CrptMCwB.js";var T=a(`navigation`,[[`polygon`,{points:`3 11 22 2 13 21 11 13 3 11`,key:`1ltx0t`}]]),E=h(f(),1),D=o(),O=50,k=()=>{let a=s(),o=m().state?.operator,{data:f,isLoading:h}=w(),{data:k=[]}=y(),j=S(),M=d(),[N,P]=(0,E.useState)(null),[te,F]=(0,E.useState)(!1),[I,L]=(0,E.useState)(null),[R,z]=(0,E.useState)(!1),[B,V]=(0,E.useState)(!1),[H,U]=(0,E.useState)(``),[W,G]=(0,E.useState)(``),[K,q]=(0,E.useState)(``),J=[`SIM Damaged`,`Lost SIM`,`Network Upgrade (4G→5G)`,`Other`];if((0,E.useEffect)(()=>{k.length>0&&!N&&P((k.find(e=>e.isDefault)||k[0])._id)},[k,N]),!o)return(0,D.jsxs)(`div`,{className:`sr-loading`,children:[(0,D.jsx)(`style`,{children:A}),(0,D.jsx)(`p`,{style:{color:`#4F46E5`,fontWeight:700},children:`No operator selected.`}),(0,D.jsx)(`button`,{className:`sr-back-btn`,onClick:()=>a(`/simreplacement`),children:`Go Back`})]});let Y=o.id===`jio`,X=k.find(e=>e._id===N),Z=H.length===10,Q=H.length>0&&H.length<10,$=`${o.id.slice(0,3).toUpperCase()}-${H?H.slice(-4):`····`}`,ne=()=>{if(!navigator.geolocation){u.error(`Location not supported on this device`);return}navigator.geolocation.getCurrentPosition(async e=>{let{latitude:t,longitude:n}=e.coords;try{let e=(await(await fetch(`https://nominatim.openstreetmap.org/reverse?lat=${t}&lon=${n}&format=json`)).json()).address||{},r=`Current Location`,i=e.road||e.suburb||e.neighbourhood||``,a=e.city||e.town||e.village||`Gurugram`,o=e.state||`Haryana`,s=e.postcode||`000000`,c=k.find(e=>e.houseNo===`Current Location`),l;l=c?await g.put(`/address/${c._id}`,{houseNo:r,street:i,city:a,state:o,pincode:s,latitude:t,longitude:n}):await g.post(`/address`,{houseNo:r,street:i,city:a,state:o,pincode:s,latitude:t,longitude:n});let d=l.data.data;M.invalidateQueries({queryKey:[`address`]}),P(d._id),u.success(`Location fetched 📍`)}catch{u.error(`Failed to fetch address`)}},()=>u.error(`Location permission denied`))},re=async()=>{if(!X)return u.error(`Select a delivery address`);if(!Z)return u.error(`Enter a valid 10-digit existing number`);if(!K)return u.error(`Select a reason for replacement`);V(!0);try{await g.post(`/sim-replacement`,{addressId:X._id,operatorId:o.id,existingNumber:H,lastRechargeAmount:W,reason:K,paymentMethod:`COD`}),z(!0)}catch(e){u.error(e?.response?.data?.message||`Request failed ❌`)}finally{V(!1)}};return h?(0,D.jsxs)(`div`,{className:`sr-loading`,children:[(0,D.jsx)(`style`,{children:A}),(0,D.jsx)(`div`,{className:`sr-spinner`})]}):(0,D.jsxs)(`div`,{className:`sr-root`,style:{"--op-color":o.color},children:[(0,D.jsx)(`style`,{children:A}),(0,D.jsxs)(`nav`,{className:`sr-nav`,children:[(0,D.jsxs)(`button`,{className:`sr-back-btn`,onClick:()=>a(`/simreplacement`),children:[(0,D.jsx)(_,{size:14}),` Back`]}),(0,D.jsxs)(`div`,{className:`sr-nav-center`,children:[(0,D.jsx)(`span`,{className:`sr-nav-dot`}),(0,D.jsxs)(`span`,{className:`sr-nav-title`,children:[o.name,` · SIM Replacement`]})]}),(0,D.jsx)(`div`,{className:`sr-nav-ref`,children:!Y&&!R?$:``})]}),(0,D.jsxs)(`div`,{className:`sr-hero`,children:[(0,D.jsx)(`div`,{className:`sr-hero-bg`}),(0,D.jsxs)(`div`,{className:`sr-hero-inner`,children:[(0,D.jsxs)(`div`,{className:`sr-hero-left`,children:[(0,D.jsx)(`div`,{className:`sr-hero-icon`,children:Y?(0,D.jsx)(n,{size:20}):(0,D.jsx)(i,{size:20})}),(0,D.jsxs)(`div`,{children:[(0,D.jsx)(`div`,{className:`sr-hero-eyebrow`,children:Y?`In-store request`:`Doorstep request`}),(0,D.jsx)(`div`,{className:`sr-hero-title`,children:Y?`Visit your nearest Jio store`:`Get a replacement SIM, same number`}),(0,D.jsx)(`div`,{className:`sr-hero-sub`,children:Y?`Aadhaar e-KYC verification · in person only · same-day activation`:`Verify your last recharge · doorstep delivery · 24–48 hr dispatch`})]})]}),!Y&&(0,D.jsx)(`ol`,{className:`sr-hero-steps`,children:[`Verify details`,`Confirm address`,`Pay fee`,`SIM dispatched`].map((e,t)=>(0,D.jsxs)(`li`,{className:`sr-hero-step`,children:[(0,D.jsx)(`span`,{className:`sr-hero-step-num`,children:t+1}),(0,D.jsx)(`span`,{className:`sr-hero-step-lbl`,children:e})]},e))})]})]}),Y?(0,D.jsx)(`div`,{className:`sr-layout`,style:{gridTemplateColumns:`1fr`},children:(0,D.jsxs)(`div`,{className:`sr-left`,children:[(0,D.jsxs)(`div`,{className:`sr-card`,children:[(0,D.jsx)(`div`,{className:`sr-card-eyebrow`,children:`What to carry`}),(0,D.jsx)(`h2`,{className:`sr-card-title`,children:`Required for biometric e-KYC`}),(0,D.jsx)(`div`,{className:`sr-jio-grid`,children:[{icon:p,label:`Aadhaar card`,sub:`Original, for biometric e-KYC`},{icon:l,label:`Existing Jio number`,sub:`The one you're replacing`}].map(e=>(0,D.jsxs)(`div`,{className:`sr-jio-item`,children:[(0,D.jsx)(`div`,{className:`sr-jio-icon`,children:(0,D.jsx)(e.icon,{size:17})}),(0,D.jsx)(`p`,{className:`sr-jio-label`,children:e.label}),(0,D.jsx)(`p`,{className:`sr-jio-sub`,children:e.sub})]},e.label))})]}),(0,D.jsxs)(`div`,{className:`sr-card`,children:[(0,D.jsx)(`div`,{className:`sr-card-eyebrow`,children:`Store info`}),(0,D.jsx)(`h2`,{className:`sr-card-title`,children:`Find your nearest store`}),(0,D.jsxs)(`div`,{className:`sr-store-row`,children:[(0,D.jsxs)(`div`,{className:`sr-store-info`,children:[(0,D.jsx)(t,{size:17}),(0,D.jsxs)(`div`,{children:[(0,D.jsx)(`p`,{className:`sr-store-label`,children:`Store hours`}),(0,D.jsx)(`p`,{className:`sr-store-val`,children:`10:00 AM – 8:00 PM, all days`})]})]}),(0,D.jsxs)(`div`,{className:`sr-store-info`,children:[(0,D.jsx)(T,{size:17}),(0,D.jsxs)(`div`,{children:[(0,D.jsx)(`p`,{className:`sr-store-label`,children:`Avg. wait time`}),(0,D.jsx)(`p`,{className:`sr-store-val`,children:`~15–20 minutes`})]})]})]}),(0,D.jsxs)(`a`,{href:`https://www.jio.com/store-locator`,target:`_blank`,rel:`noopener noreferrer`,className:`sr-store-cta`,children:[(0,D.jsx)(n,{size:18}),` Open store locator`]})]})]})}):R?(0,D.jsx)(`div`,{className:`sr-success-wrap`,children:(0,D.jsxs)(`div`,{className:`sr-success-card`,children:[(0,D.jsx)(`div`,{className:`sr-success-icon`,children:(0,D.jsx)(e,{size:28})}),(0,D.jsx)(`h3`,{className:`sr-success-title`,children:`Request submitted`}),(0,D.jsxs)(`p`,{className:`sr-success-sub`,children:[`Your `,o.name,` SIM replacement request has been received.`]}),(0,D.jsx)(`p`,{className:`sr-success-sub`,children:`A new SIM will be dispatched to your address within 24–48 hours.`}),(0,D.jsxs)(`div`,{className:`sr-success-ref`,children:[`Reference `,$]}),(0,D.jsx)(`button`,{className:`sr-pay-btn`,style:{maxWidth:220,margin:`22px auto 0`},onClick:()=>a(`/simreplacement`),children:`Done`})]})}):(0,D.jsxs)(`div`,{className:`sr-layout`,children:[(0,D.jsxs)(`div`,{className:`sr-left`,children:[(0,D.jsxs)(`div`,{className:`sr-card`,children:[(0,D.jsx)(`div`,{className:`sr-card-eyebrow`,children:`Step 1 of 2`}),(0,D.jsx)(`h2`,{className:`sr-card-title`,children:f?`Hey ${f.fullName||f.name} 👋`:`Delivery address`}),(0,D.jsx)(`p`,{className:`sr-card-sub`,children:`Where should we deliver your new SIM?`}),(0,D.jsx)(`div`,{className:`sr-addr-grid`,children:k.map(e=>(0,D.jsxs)(`div`,{className:`sr-addr-item${N===e._id?` sr-addr-selected`:``}`,onClick:()=>P(e._id),children:[(0,D.jsxs)(`div`,{className:`sr-addr-top`,children:[(0,D.jsxs)(`p`,{className:`sr-addr-line`,children:[e.houseNo,`, `,e.street]}),e.isDefault&&(0,D.jsx)(`span`,{className:`sr-default-badge`,children:`Default`})]}),(0,D.jsxs)(`p`,{className:`sr-addr-city`,children:[e.city,`, `,e.state,` — `,e.pincode]}),(0,D.jsxs)(`div`,{className:`sr-addr-actions`,children:[(0,D.jsxs)(`button`,{className:`sr-addr-edit`,onClick:t=>{t.stopPropagation(),L(e),F(!0)},children:[(0,D.jsx)(x,{size:11}),` Edit`]}),(0,D.jsxs)(`button`,{className:`sr-addr-del`,onClick:t=>{t.stopPropagation(),j.mutate(e._id,{onSuccess:()=>M.invalidateQueries({queryKey:[`address`]})})},children:[(0,D.jsx)(C,{size:11}),` Remove`]})]})]},e._id))}),(0,D.jsxs)(`div`,{className:`sr-addr-btns`,children:[(0,D.jsxs)(`button`,{className:`sr-add-addr-btn`,onClick:()=>{L(null),F(!0)},children:[(0,D.jsx)(b,{size:14}),` Add address`]}),(0,D.jsxs)(`button`,{className:`sr-loc-btn`,onClick:ne,children:[(0,D.jsx)(ee,{size:14}),` Use my location`]})]})]}),(0,D.jsxs)(`div`,{className:`sr-card sr-replace-card`,children:[(0,D.jsxs)(`div`,{className:`sr-replace-header`,children:[(0,D.jsx)(`div`,{className:`sr-replace-header-icon`,children:(0,D.jsx)(c,{size:19})}),(0,D.jsxs)(`div`,{children:[(0,D.jsx)(`div`,{className:`sr-card-eyebrow`,style:{marginBottom:2},children:`Step 2 of 2 — Verification`}),(0,D.jsx)(`h2`,{className:`sr-card-title`,style:{marginBottom:0},children:`Your current number & last recharge`})]})]}),(0,D.jsx)(`p`,{className:`sr-card-sub`,style:{marginTop:14},children:`This helps us confirm ownership before issuing your new SIM`}),(0,D.jsxs)(`div`,{className:`sr-replace-fields`,children:[(0,D.jsxs)(`div`,{className:`sr-field-group`,children:[(0,D.jsxs)(`label`,{className:`sr-field-label`,children:[`Existing `,o.name,` number`]}),(0,D.jsxs)(`div`,{className:`sr-number-wrap`,children:[(0,D.jsx)(`div`,{className:`sr-number-prefix`,children:`+91`}),(0,D.jsx)(`input`,{className:`sr-number-input${Z?` sr-input-ok`:Q?` sr-input-warn`:``}`,type:`tel`,inputMode:`numeric`,placeholder:`Enter 10-digit number`,value:H,onChange:e=>U(e.target.value.replace(/\D/g,``).slice(0,10)),maxLength:10}),Z&&(0,D.jsx)(`div`,{className:`sr-input-check`,children:`✓`})]}),(0,D.jsx)(`div`,{className:`sr-progress-track`,children:(0,D.jsx)(`div`,{className:`sr-progress-fill${Z?` sr-progress-ok`:``}`,style:{width:`${H.length/10*100}%`}})}),(0,D.jsxs)(`div`,{className:`sr-number-meta`,children:[Z?(0,D.jsx)(`span`,{className:`sr-meta-ok`,children:`✓ Valid number — ready to verify`}):Q?(0,D.jsxs)(`span`,{className:`sr-meta-warn`,children:[10-H.length,` more digit`,10-H.length==1?``:`s`,` needed`]}):(0,D.jsx)(`span`,{className:`sr-meta-neutral`,children:`This number will receive the activation OTP`}),(0,D.jsxs)(`span`,{className:`sr-meta-count`,children:[H.length,`/10`]})]})]}),(0,D.jsx)(`div`,{className:`sr-divider`,children:(0,D.jsx)(`span`,{className:`sr-divider-label`,children:`Last recharge details`})}),(0,D.jsxs)(`div`,{className:`sr-field-group`,children:[(0,D.jsxs)(`label`,{className:`sr-field-label`,children:[`Last recharge amount (₹) `,(0,D.jsx)(`span`,{className:`sr-optional-tag`,children:`Optional`})]}),(0,D.jsx)(`input`,{className:`sr-text-input`,type:`number`,placeholder:`e.g. 299`,value:W,onChange:e=>G(e.target.value)})]}),(0,D.jsx)(`div`,{className:`sr-divider`,children:(0,D.jsx)(`span`,{className:`sr-divider-label`,children:`Reason for replacement`})}),(0,D.jsx)(`div`,{className:`sr-field-group`,children:(0,D.jsx)(`div`,{className:`sr-reason-grid`,children:J.map(e=>(0,D.jsx)(`button`,{type:`button`,onClick:()=>q(e),className:`sr-reason-card${K===e?` sr-reason-active`:``}`,children:e},e))})}),(0,D.jsxs)(`div`,{className:`sr-timeline`,children:[(0,D.jsx)(`div`,{className:`sr-timeline-header`,children:`What happens next`}),(0,D.jsx)(`div`,{className:`sr-timeline-items`,children:[{title:`Identity verified`,desc:`We match your number and last recharge to confirm ownership`},{title:`SIM dispatched`,desc:`New SIM card delivered to your address within 24–48 hours`},{title:`Activated`,desc:`Insert the new SIM — your number stays exactly the same`}].map((e,t)=>(0,D.jsxs)(`div`,{className:`sr-timeline-item`,children:[(0,D.jsx)(`div`,{className:`sr-timeline-icon`,children:t+1}),(0,D.jsx)(`div`,{className:`sr-timeline-line`}),(0,D.jsxs)(`div`,{className:`sr-timeline-content`,children:[(0,D.jsx)(`div`,{className:`sr-timeline-title`,children:e.title}),(0,D.jsx)(`div`,{className:`sr-timeline-desc`,children:e.desc})]})]},t))})]})]})]})]}),(0,D.jsx)(`div`,{className:`sr-right`,children:(0,D.jsxs)(`div`,{className:`sr-ticket`,children:[(0,D.jsxs)(`div`,{className:`sr-ticket-top`,children:[(0,D.jsxs)(`div`,{className:`sr-summary-header`,children:[(0,D.jsx)(r,{size:14}),(0,D.jsx)(`span`,{children:`Replacement docket`})]}),(0,D.jsxs)(`div`,{className:`sr-op-row`,children:[(0,D.jsx)(`div`,{className:`sr-op-avatar`,children:o.name[0]}),(0,D.jsxs)(`div`,{children:[(0,D.jsxs)(`span`,{className:`sr-op-name`,children:[o.name,` SIM replacement`]}),(0,D.jsx)(`div`,{className:`sr-op-sub`,children:`New SIM, same number`})]}),(0,D.jsx)(`div`,{className:`sr-ticket-id`,children:$})]}),(0,D.jsx)(`div`,{className:`sr-spec-box`,children:[{label:`Existing number`,val:H?`+91 ${H}`:`—`},{label:`Last recharge`,val:W?`₹${W}`:`Not provided`},{label:`Reason`,val:K||`—`}].map((e,t)=>(0,D.jsxs)(`div`,{className:`sr-spec-row`,children:[(0,D.jsx)(`span`,{className:`sr-spec-key`,children:e.label}),(0,D.jsx)(`span`,{className:`sr-spec-val`,children:e.val})]},t))})]}),(0,D.jsxs)(`div`,{className:`sr-perf`,children:[(0,D.jsx)(`span`,{className:`sr-perf-notch sr-perf-notch-l`}),(0,D.jsx)(`span`,{className:`sr-perf-line`}),(0,D.jsx)(`span`,{className:`sr-perf-notch sr-perf-notch-r`})]}),(0,D.jsxs)(`div`,{className:`sr-ticket-bottom`,children:[(0,D.jsxs)(`div`,{className:`sr-price-section`,children:[(0,D.jsxs)(`div`,{className:`sr-price-row`,children:[(0,D.jsx)(`span`,{children:`Replacement fee`}),(0,D.jsxs)(`span`,{children:[`₹`,O]})]}),(0,D.jsxs)(`div`,{className:`sr-price-row`,children:[(0,D.jsx)(`span`,{children:`Delivery`}),(0,D.jsx)(`span`,{className:`sr-free-tag`,children:`Free`})]}),(0,D.jsx)(`div`,{className:`sr-price-divider`}),(0,D.jsxs)(`div`,{className:`sr-price-total-row`,children:[(0,D.jsx)(`span`,{children:`Total`}),(0,D.jsxs)(`span`,{children:[`₹`,O]})]})]}),(0,D.jsxs)(`div`,{className:`sr-info-section`,children:[(0,D.jsxs)(`div`,{className:`sr-info-row`,children:[(0,D.jsx)(`span`,{className:`sr-info-key`,children:`Deliver to`}),(0,D.jsx)(`span`,{className:`sr-info-val`,children:X?`${X.houseNo}, ${X.street}`:`—`})]}),(0,D.jsxs)(`div`,{className:`sr-info-row`,children:[(0,D.jsx)(`span`,{className:`sr-info-key`,children:`Payment`}),(0,D.jsx)(`span`,{className:`sr-info-val`,children:`Cash on delivery`})]})]}),(0,D.jsxs)(`div`,{className:`sr-readiness`,children:[(0,D.jsxs)(`div`,{className:`sr-ready-row`,children:[(0,D.jsx)(`span`,{className:`sr-ready-dot${N?` ok`:``}`}),(0,D.jsx)(`span`,{className:`sr-ready-txt${N?` ok`:``}`,children:`Delivery address`})]}),(0,D.jsxs)(`div`,{className:`sr-ready-row`,children:[(0,D.jsx)(`span`,{className:`sr-ready-dot${Z?` ok`:``}`}),(0,D.jsxs)(`span`,{className:`sr-ready-txt${Z?` ok`:``}`,children:[`Mobile number (`,H.length,`/10)`]})]}),(0,D.jsxs)(`div`,{className:`sr-ready-row`,children:[(0,D.jsx)(`span`,{className:`sr-ready-dot${K?` ok`:``}`}),(0,D.jsxs)(`span`,{className:`sr-ready-txt${K?` ok`:``}`,children:[`Reason `,K?`(${K})`:``]})]})]}),(0,D.jsx)(`button`,{className:`sr-pay-btn`,onClick:re,disabled:B,children:B?`Submitting…`:(0,D.jsxs)(D.Fragment,{children:[(0,D.jsx)(c,{size:16,style:{marginRight:6,verticalAlign:-2}}),`Confirm replacement — ₹`,O]})}),(0,D.jsx)(`button`,{className:`sr-cancel-btn`,onClick:()=>a(-1),children:`Cancel`})]})]})})]}),te&&(0,D.jsx)(v,{close:()=>{F(!1),L(null)},editingAddress:I})]})},A=`
