import{t as e}from"./clock-y3c5V5Fu.js";import{t}from"./message-square-B3QXiWkc.js";import{t as n}from"./package-DmECd77W.js";import{t as r}from"./wifi--Nt-cfUw.js";import{t as i}from"./zap-CEEzkOgj.js";import{B as a,I as o,K as s,L as c,M as l,O as u,P as d,U as f,W as p,X as m,b as h,k as g,z as _}from"./index-1P5gsGLx.js";import{t as v}from"./useUser-DiOLSqLF.js";import{t as y}from"./useEsim-Dd5fuid2.js";var b=m(s(),1);const x=()=>c({mutationFn:async e=>{let t=localStorage.getItem(`token`),n={};return t&&(n.Authorization=`Bearer ${t}`),(await h.post(`/esim/order`,e,{headers:n})).data.data}});var S=a(),C=`
