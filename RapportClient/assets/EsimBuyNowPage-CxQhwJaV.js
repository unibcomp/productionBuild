import{t as e}from"./clock-Rq8BDWud.js";import{t}from"./message-square-B5W9DzzH.js";import{t as n}from"./package-BXG6TWjw.js";import{t as r}from"./wifi-KNfloQyc.js";import{t as i}from"./zap-ClPVdlV6.js";import{B as a,I as o,K as s,L as c,M as l,O as u,P as d,U as f,W as p,X as m,b as h,k as g,z as _}from"./index-CjoqAJHd.js";import{t as v}from"./useUser-CWYOcdtt.js";import{t as y}from"./useEsim-D3cK4Ob8.js";var b=m(s(),1);const x=()=>c({mutationFn:async e=>{let t=localStorage.getItem(`token`),n={};return t&&(n.Authorization=`Bearer ${t}`),(await h.post(`/esim/order`,e,{headers:n})).data.data}});var S=a(),C=`
