import{t as e}from"./check-H6SmlPZ9.js";import{t}from"./clock-CWQz2BVn.js";import{t as n}from"./message-square-BNFnJTx1.js";import{n as r,t as i}from"./plus-CIWyfFTe.js";import{t as a}from"./wifi-DvUJTBff.js";import{t as o}from"./zap-DXWD8SqK.js";import{A as s,B as c,G as l,J as u,M as d,P as f,S as p,U as m,Y as h,Z as g,g as _,q as v,tt as y,w as b,x,z as ee}from"./index-D-zxq-Ip.js";import{t as S}from"./proxy-B9Sxw88z.js";import{t as C}from"./AnimatePresence-Cz3GYKPu.js";import{t as w}from"./usePlanTypes-CXLOr-la.js";import{t as te}from"./useServices-BL8HeFzW.js";import{t as ne}from"./usePlans-Bo6d7QYI.js";import{t as re}from"./useUser-CrptMCwB.js";import{n as ie}from"./useCheckout-BDUcg9sh.js";import{t as ae}from"./usePlanTags-T74w0MnB.js";var oe=c(`shield`,[[`path`,{d:`M20 13c0 5-3.5 7.5-7.66 8.95a1 1 0 0 1-.67-.01C7.5 20.5 4 18 4 13V6a1 1 0 0 1 1-1c2 0 4.5-1.2 6.24-2.72a1.17 1.17 0 0 1 1.52 0C14.51 3.81 17 5 19 5a1 1 0 0 1 1 1z`,key:`oel41y`}]]),se=c(`signal`,[[`path`,{d:`M2 20h.01`,key:`4haj6o`}],[`path`,{d:`M7 20v-4`,key:`j294jx`}],[`path`,{d:`M12 20v-8`,key:`i3yub9`}],[`path`,{d:`M17 20V8`,key:`1tkaf5`}],[`path`,{d:`M22 4v16`,key:`sih9yq`}]]),ce=c(`star`,[[`path`,{d:`M11.525 2.295a.53.53 0 0 1 .95 0l2.31 4.679a2.123 2.123 0 0 0 1.595 1.16l5.166.756a.53.53 0 0 1 .294.904l-3.736 3.638a2.123 2.123 0 0 0-.611 1.878l.882 5.14a.53.53 0 0 1-.771.56l-4.618-2.428a2.122 2.122 0 0 0-1.973 0L6.396 21.01a.53.53 0 0 1-.77-.56l.881-5.139a2.122 2.122 0 0 0-.611-1.879L2.16 9.795a.53.53 0 0 1 .294-.906l5.165-.755a2.122 2.122 0 0 0 1.597-1.16z`,key:`r04s7s`}]]),le=c(`tag`,[[`path`,{d:`M12.586 2.586A2 2 0 0 0 11.172 2H4a2 2 0 0 0-2 2v7.172a2 2 0 0 0 .586 1.414l8.704 8.704a2.426 2.426 0 0 0 3.42 0l6.58-6.58a2.426 2.426 0 0 0 0-3.42z`,key:`vktsd0`}],[`circle`,{cx:`7.5`,cy:`7.5`,r:`.5`,fill:`currentColor`,key:`kqv944`}]]),T=y(g(),1);const E=e=>m({queryKey:e?[`vipCategory`,e]:[`vipCategories`],queryFn:async()=>{try{let t=e?`/vip-category/${e}`:`/vip-category`,{data:n}=await b.get(t);return console.log(`VIP API RESPONSE:`,n),n.data}catch(e){let t=e;throw console.error(`Failed to fetch VIP category:`,e),Error(t.response?.data?.message||t.message||`Something went wrong`)}},enabled:!0,staleTime:300*1e3,retry:2});var D=l(),O=()=>{let{state:c}=v();console.log(`Location State:`,c),console.log(`Order Type:`,c?.orderType);let{id:l}=h(),m=u(),{data:g,isLoading:y}=ne(l||c?._id),{data:b}=re(),{data:O}=te(typeof g?.serviceId==`string`?g.serviceId:g?.serviceId?._id),{data:A}=E(g?.vipCategoryId?._id),{data:j=[]}=ae(),{data:M=[]}=w(),{mutate:N,isPending:P}=_(),{mutate:F,isPending:I}=ie(),[L,R]=(0,T.useState)(!1),[z,B]=(0,T.useState)(!1),[V,H]=(0,T.useState)(1),[U,W]=(0,T.useState)(!1),G=c?.orderType===`PORT`,ue=c?.orderType===`ESIM`,de=G||ue;if((0,T.useEffect)(()=>(L?document.body.style.overflow=`hidden`:document.body.style.overflow=``,()=>{document.body.style.overflow=``}),[L]),y)return(0,D.jsxs)(`div`,{className:`pd-center-screen`,children:[(0,D.jsx)(`style`,{children:k}),(0,D.jsxs)(`div`,{className:`pd-loading-card`,children:[(0,D.jsx)(`div`,{className:`pd-spinner`}),(0,D.jsx)(`p`,{className:`pd-loading-text`,children:`Fetching plan details…`})]})]});if(!g)return(0,D.jsxs)(`div`,{className:`pd-center-screen`,children:[(0,D.jsx)(`style`,{children:k}),(0,D.jsxs)(`div`,{className:`pd-notfound-card`,children:[(0,D.jsx)(`div`,{className:`pd-notfound-icon`,children:`🔍`}),(0,D.jsx)(`h2`,{className:`pd-notfound-title`,children:`Plan not found`}),(0,D.jsx)(`p`,{className:`pd-notfound-sub`,children:`This plan may no longer be available.`}),(0,D.jsx)(`button`,{onClick:()=>m(-1),className:`pd-notfound-btn`,children:`← Go Back`})]})]});let K=O?.[0],q=Array.isArray(A)?A[0]:A,fe=typeof g.planTypeId==`object`?g.planTypeId?._id:g.planTypeId,J=j.filter(e=>g.planTagsId?.includes(e._id)),Y=M.find(e=>e._id===fe),pe=()=>{if(!b)return R(!0);let e=c?.orderType||`NORMAL`;F({type:`DIRECT`,planId:g._id,quantity:V},{onSuccess:t=>{m(`/buy-now/${t.sessionId}`,{state:{orderType:e,quantity:V}})}})},me=()=>{if(!b)return R(!0);N({planId:g._id,quantity:V},{onSuccess:()=>{W(!0),setTimeout(()=>W(!1),2e3)}})},X=g.salePrice&&g.price?Math.round((g.price-g.salePrice)/g.price*100):null,Z=typeof g.operatorId==`object`?g.operatorId?.name:`Operator`,Q=typeof g.operatorId==`object`?g.operatorId?.logo:``,he=[{icon:(0,D.jsx)(a,{size:16}),num:g.data??`—`,lbl:`Data / Day`,color:`#3B82F6`},{icon:(0,D.jsx)(t,{size:16}),num:g.validity?`${g.validity}d`:`—`,lbl:`Validity`,color:`#8B5CF6`},{icon:(0,D.jsx)(f,{size:16}),num:g.calls??`—`,lbl:`Calls`,color:`#10B981`},{icon:(0,D.jsx)(n,{size:16}),num:g.sms??`—`,lbl:`SMS / Day`,color:`#F59E0B`},{icon:(0,D.jsx)(se,{size:16}),num:g.networkType??`—`,lbl:`Network`,color:`#EF4444`}],$=[{key:`Data`,val:g.data},{key:`Validity`,val:g.validity?`${g.validity} Days`:null},{key:`Calls`,val:g.calls},{key:`SMS`,val:g.sms},{key:`Network`,val:g.networkType},{key:`Service`,val:K?.name||(typeof g.serviceId==`string`?g.serviceId:g.serviceId?.name)},{key:`Plan Type`,val:Y?.name||`N/A`}].filter(e=>e.val);return(0,D.jsxs)(`div`,{className:`pd-root`,children:[(0,D.jsx)(`style`,{children:k}),(0,D.jsxs)(`nav`,{className:`pd-nav`,children:[(0,D.jsxs)(`button`,{className:`pd-back-btn`,onClick:()=>m(-1),children:[(0,D.jsx)(ee,{size:14}),` Back`]}),(0,D.jsx)(`div`,{className:`pd-nav-center`,children:(0,D.jsx)(`span`,{className:`pd-nav-label`,children:`Plan Details`})}),(0,D.jsx)(`div`,{style:{width:38}})]}),(0,D.jsxs)(S.div,{className:`pd-hero-card`,initial:{opacity:0,y:20},animate:{opacity:1,y:0},transition:{duration:.42},children:[(0,D.jsxs)(`div`,{className:`pd-hero-top`,children:[(0,D.jsxs)(`div`,{className:`pd-op-group`,children:[(0,D.jsx)(`div`,{className:`pd-op-avatar`,children:Q?(0,D.jsx)(`img`,{src:Q,alt:``,style:{width:32,height:32,objectFit:`contain`}}):(0,D.jsx)(`span`,{style:{fontSize:20},children:`📶`})}),(0,D.jsxs)(`div`,{children:[(0,D.jsx)(`div`,{className:`pd-op-name`,children:Z}),(0,D.jsx)(`div`,{className:`pd-op-sub`,children:Y?.name||K?.name||`Prepaid`})]})]}),(0,D.jsxs)(`div`,{className:`pd-hero-badges`,children:[q&&(0,D.jsxs)(`span`,{className:`pd-badge pd-badge-vip`,children:[`👑 `,q.name]}),X&&(0,D.jsxs)(`span`,{className:`pd-badge pd-badge-disc`,children:[X,`% OFF`]})]})]}),(0,D.jsxs)(`div`,{className:`pd-hero-body`,children:[(0,D.jsxs)(`div`,{className:`pd-hero-info`,children:[(0,D.jsxs)(`h1`,{className:`pd-plan-title`,children:[Z,(0,D.jsxs)(`span`,{className:`pd-plan-title-accent`,children:[` `,Y?.name||g.networkType||`Mobile`]}),(0,D.jsx)(`br`,{}),`Plan`]}),g.description&&(0,D.jsx)(`p`,{className:`pd-plan-desc`,children:g.description}),J.length>0&&(0,D.jsx)(`div`,{className:`pd-tags-row`,children:J.map(e=>(0,D.jsxs)(`span`,{className:`pd-tag`,children:[(0,D.jsx)(le,{size:10}),` `,e.name]},e._id))})]}),(0,D.jsxs)(`div`,{className:`pd-price-block`,children:[(0,D.jsx)(`div`,{className:`pd-price-you-pay`,children:`You Pay`}),(0,D.jsxs)(`div`,{className:`pd-price-amount`,children:[`₹`,g.salePrice||g.price]}),g.salePrice&&(0,D.jsxs)(`div`,{className:`pd-price-was`,children:[(0,D.jsxs)(`span`,{className:`pd-price-strike`,children:[`₹`,g.price]}),(0,D.jsxs)(`span`,{className:`pd-price-save`,children:[`Save ₹`,g.price-g.salePrice]})]})]})]})]}),(0,D.jsx)(S.div,{className:`pd-stats-row`,initial:{opacity:0,y:12},animate:{opacity:1,y:0},transition:{delay:.1,duration:.35},children:he.map((e,t)=>(0,D.jsxs)(`div`,{className:`pd-stat-card`,children:[(0,D.jsx)(`div`,{className:`pd-stat-icon`,style:{color:e.color,background:`${e.color}15`},children:e.icon}),(0,D.jsx)(`div`,{className:`pd-stat-num`,children:e.num}),(0,D.jsx)(`div`,{className:`pd-stat-lbl`,children:e.lbl})]},t))}),(0,D.jsxs)(S.div,{className:`pd-details-grid`,initial:{opacity:0,y:14},animate:{opacity:1,y:0},transition:{delay:.18,duration:.36},children:[(0,D.jsxs)(`div`,{className:`pd-detail-card`,children:[(0,D.jsxs)(`div`,{className:`pd-detail-header`,children:[(0,D.jsx)(`div`,{className:`pd-detail-header-icon`,style:{background:`#EFF6FF`,color:`#3B82F6`},children:(0,D.jsx)(oe,{size:14})}),(0,D.jsx)(`span`,{children:`Plan Specifications`})]}),(0,D.jsx)(`div`,{className:`pd-spec-list`,children:$.length>0?$.map((e,t)=>(0,D.jsxs)(S.div,{className:`pd-spec-item`,initial:{opacity:0,x:-10},animate:{opacity:1,x:0},transition:{delay:.24+t*.04},children:[(0,D.jsx)(`span`,{className:`pd-spec-key`,children:e.key}),(0,D.jsx)(`span`,{className:`pd-spec-val`,children:e.val})]},t)):(0,D.jsx)(`div`,{className:`pd-empty-state`,children:`No specifications available`})})]}),(0,D.jsxs)(`div`,{className:`pd-detail-card`,children:[(0,D.jsxs)(`div`,{className:`pd-detail-header`,children:[(0,D.jsx)(`div`,{className:`pd-detail-header-icon`,style:{background:`#F0FDF4`,color:`#10B981`},children:(0,D.jsx)(ce,{size:14})}),(0,D.jsx)(`span`,{children:`Benefits Included`})]}),(0,D.jsx)(`div`,{className:`pd-benefit-list`,children:g.benefits?.length?g.benefits.map((e,t)=>(0,D.jsxs)(S.div,{className:`pd-benefit-item`,initial:{opacity:0,x:10},animate:{opacity:1,x:0},transition:{delay:.24+t*.05},children:[(0,D.jsx)(`div`,{className:`pd-benefit-dot`}),(0,D.jsx)(`span`,{children:e})]},t)):(0,D.jsx)(`div`,{className:`pd-empty-state`,children:`No benefits listed for this plan`})})]})]}),K?.description&&(0,D.jsxs)(S.div,{className:`pd-service-banner`,initial:{opacity:0},animate:{opacity:1},transition:{delay:.3},children:[(0,D.jsx)(`div`,{className:`pd-service-icon-box`,children:(0,D.jsx)(o,{size:16})}),(0,D.jsxs)(`div`,{children:[(0,D.jsx)(`div`,{className:`pd-service-label`,children:`Service Info`}),(0,D.jsx)(`p`,{className:`pd-service-desc`,children:K.description})]})]}),(0,D.jsx)(`div`,{style:{height:110}}),(0,D.jsxs)(`div`,{className:`pd-bottom-bar`,children:[(0,D.jsxs)(`div`,{className:`pd-bottom-price-group`,children:[(0,D.jsx)(`div`,{className:`pd-bottom-label`,children:`Total`}),(0,D.jsxs)(`div`,{className:`pd-bottom-price-row`,children:[(0,D.jsxs)(`span`,{className:`pd-bottom-price`,children:[`₹`,(g.salePrice||g.price)*V]}),g.salePrice&&(0,D.jsxs)(`span`,{className:`pd-bottom-was`,children:[`₹`,g.price*V]}),X&&(0,D.jsxs)(`span`,{className:`pd-bottom-badge`,children:[X,`% off`]})]})]}),(0,D.jsxs)(`div`,{className:`pd-bottom-actions`,children:[!de&&(0,D.jsxs)(D.Fragment,{children:[(0,D.jsxs)(`div`,{className:`pd-qty-stepper`,children:[(0,D.jsx)(`button`,{className:`pd-qty-btn`,onClick:()=>H(e=>Math.max(1,e-1)),disabled:V<=1,children:(0,D.jsx)(r,{size:13})}),(0,D.jsx)(`span`,{className:`pd-qty-num`,children:V}),(0,D.jsx)(`button`,{className:`pd-qty-btn`,onClick:()=>H(e=>Math.min(10,e+1)),disabled:V>=10,children:(0,D.jsx)(i,{size:13})})]}),(0,D.jsx)(`button`,{className:`pd-cart-btn${U?` pd-cart-btn-added`:``}`,onClick:me,disabled:P,children:U?(0,D.jsxs)(D.Fragment,{children:[(0,D.jsx)(e,{size:15}),` Added!`]}):P?(0,D.jsxs)(D.Fragment,{children:[(0,D.jsx)(d,{size:15}),` Adding…`]}):(0,D.jsxs)(D.Fragment,{children:[(0,D.jsx)(d,{size:15}),` Add to Cart`]})})]}),(0,D.jsx)(`button`,{className:`pd-buy-btn`,onClick:pe,disabled:I,children:I?`Processing...`:G?`Port Now →`:`Buy Now →`})]})]}),(0,D.jsx)(C,{children:L&&(0,D.jsx)(S.div,{className:`pd-overlay`,initial:{opacity:0},animate:{opacity:1},exit:{opacity:0},children:(0,D.jsxs)(S.div,{className:`pd-modal`,initial:{opacity:0,scale:.94,y:24},animate:{opacity:1,scale:1,y:0},exit:{opacity:0,scale:.94,y:24},transition:{duration:.22},children:[(0,D.jsxs)(`div`,{className:`pd-modal-head`,children:[(0,D.jsx)(`button`,{className:`pd-modal-close`,onClick:()=>R(!1),children:(0,D.jsx)(s,{size:14})}),(0,D.jsx)(`h3`,{className:`pd-modal-title`,children:z?`Create Account`:`Welcome Back`}),(0,D.jsx)(`p`,{className:`pd-modal-sub`,children:z?`Sign up to complete your purchase`:`Log in to complete your purchase`})]}),(0,D.jsx)(`div`,{className:`pd-modal-tabs`,children:[`login`,`signup`].map(e=>(0,D.jsx)(`button`,{className:`pd-tab${e===(z?`signup`:`login`)?` pd-tab-active`:``}`,onClick:()=>B(e===`signup`),children:e===`login`?`Login`:`Sign Up`},e))}),(0,D.jsx)(`div`,{className:`pd-modal-body`,children:z?(0,D.jsx)(p,{onSuccess:()=>R(!1)}):(0,D.jsx)(x,{onSuccess:()=>R(!1),onSignupRedirect:()=>{},onForgotRedirect:()=>{}})})]})})})]})},k=`
